...
public final class c extends g.i implements i {
    ...
    */
    ...
    private void a(b bVar) throws IOException {
        ...
        try {
            try {
                SSLSocket sSLSocket2 = (SSLSocket) a2.j().createSocket(this.d, a2.k().g(), a2.k().j(), true);
                try {
                    k a3 = bVar.a(sSLSocket2);
                    if (a3.c()) {
                        bykvm_19do.bykvm_19do.bykvm_for12.bykvm_19do.bykvm_19do.bykvm_if122.bykvm_if122.bykvm_19do.bykvm_try19.e.b().a(sSLSocket2, a2.k().g(), a2.e());
                    }
                    sSLSocket2.startHandshake();
                    q a4 = q.a(sSLSocket2.getSession());
                    if (a2.d().verify(a2.k().g(), sSLSocket2.getSession())) {
                        a2.a().a(a2.k().g(), a4.b());
                        String b = a3.c() ? bykvm_19do.bykvm_19do.bykvm_for12.bykvm_19do.bykvm_19do.bykvm_if122.bykvm_if122.bykvm_19do.bykvm_try19.e.b().b(sSLSocket2) : null;
                        this.e = sSLSocket2;
