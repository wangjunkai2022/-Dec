...
public class a implements com.ss.android.downloadad.api.a, b.c, a.InterfaceC0150a, ag {

    /* renamed from: a  reason: collision with root package name */
    public static String f11564a = "a";
    ...
    public static class b implements Runnable {
        ...
        public boolean a() {
            ...
            com.ss.android.downloadad.api.a.b d = com.ss.android.downloadlib.addownload.b.f.a().d(this.f11571a);
            boolean z = false;
            if (d == null || l.b(d) || d.c.get() || (downloadInfo = Downloader.getInstance(j.getContext()).getDownloadInfo(d.s())) == null) {
                return false;
            }
            long M = d.M();
            ...
            z = (M <= -1 || totalBytes <= -1 || ((double) M) >= (2.5d * d2) + ((double) min)) ? true : true;
            boolean a3 = com.ss.android.socialbase.appdownloader.b.a(j.getContext());
            JSONObject jSONObject2 = new JSONObject();
            int a4 = a(z, d, downloadInfo, a3, jSONObject2);
            this.d = a4;
            try {
            ...
            try {
                ...
                jSONObject.putOpt("available_space", Long.valueOf(M / DownloadInfo.DEFAULT_MIN_BYTES_INTERVAL));
                jSONObject.putOpt("total_space", Long.valueOf(a2 / DownloadInfo.DEFAULT_MIN_BYTES_INTERVAL));
                int i = (totalBytes > 0L ? 1 : (totalBytes == 0L ? 0 : -1));
                if (i > 0) {
                    jSONObject.putOpt(NativeUnifiedADAppInfoImpl.Keys.PACKAGE_SIZE, Long.valueOf(totalBytes / DownloadInfo.DEFAULT_MIN_BYTES_INTERVAL));
                }
                ...
                jSONObject.put("is_update_download", d.V() ? 1 : 2);
            } catch (Exception e2) {
                e = e2;
                e.printStackTrace();
                com.ss.android.downloadlib.d.a.a().b("install_failed", jSONObject, d);
                return true;
            }
            com.ss.android.downloadlib.d.a.a().b("install_failed", jSONObject, d);
            return true;
    ...
    public void c() {
        com.ss.android.socialbase.downloader.c.a.b(f11564a, "onAppBackground()");
        a(6);
    }

    @Override // com.ss.android.socialbase.downloader.a.a.InterfaceC0150a
    public void b() {
        com.ss.android.socialbase.downloader.c.a.b(f11564a, "onAppForeground()");
        d();
        a(5);
    }
    ...
    public void a(DownloadInfo downloadInfo, com.ss.android.downloadad.api.a.b bVar, int i) {
        ...
        if (i != 2000) {
            max = ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS;
        } else {
    ...
    public void a(long j) {
        ...
        try {
            ...
            if (d2 != null && !l.b(d2) && !d2.c.get()) {
                ...
                com.ss.android.downloadlib.addownload.b.d.a().b(a2.f11596a);
                JSONObject jSONObject = new JSONObject();
                jSONObject.put("installed_app_name", a2.d);
                jSONObject.put("installed_pkg_name", a2.f11596a);
                if (i != -1) {
    ...
    public void a(int i) {
        ...
        d.a().a(new RunnableC0133a(i), this.b > 0 ? ItemTouchHelper.Callback.DRAG_SCROLL_ACCELERATION_LIMIT_TIME_MS : 8000L);
