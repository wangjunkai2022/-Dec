...
public class n extends com.ss.android.socialbase.downloader.downloader.a implements ServiceConnection {
    ...
    public void b(DownloadTask downloadTask) {
        ...
        String str = e;
        StringBuilder m1016super = Cgoto.m1016super("tryDownload aidlService == null:");
        m1016super.append(this.f == null);
    ...
    public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
        ...
        String str = e;
        StringBuilder m1016super = Cgoto.m1016super("onServiceConnected aidlService!=null");
        m1016super.append(this.f != null);
        m1016super.append(" pendingTasks.size:");
        m1016super.append(this.f11856a.size());
        com.ss.android.socialbase.downloader.c.a.b(str, m1016super.toString());
        if (this.f != null) {
