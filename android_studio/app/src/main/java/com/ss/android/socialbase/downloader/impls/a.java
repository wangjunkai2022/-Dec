...
public abstract class a implements h.a {
    ...
    public final com.ss.android.socialbase.downloader.h.h f11951a = new com.ss.android.socialbase.downloader.h.h(Looper.getMainLooper(), this);
    ...
    private void c(DownloadTask downloadTask) {
        ...
        try {
            if (this.j.isEmpty()) {
                ...
                this.j.put(downloadTask);
                new com.ss.android.socialbase.downloader.downloader.f(downloadTask, this.f11951a).a();
            } else {
    ...
    public synchronized boolean e(int i) {
        ...
        if (b == null || b.getStatus() != 11) {
            ...
            if (b == null) {
                DownloadTask downloadTask = this.b.get(i);
                if (downloadTask != null) {
                    new com.ss.android.socialbase.downloader.downloader.f(downloadTask, this.f11951a).d();
                    return true;
                }
            } else {
                a(b);
                if (b.getStatus() == 1) {
                    ...
                    if (downloadTask2 != null) {
                        new com.ss.android.socialbase.downloader.downloader.f(downloadTask2, this.f11951a).d();
                        return true;
                    }
    ...
    */
    ...
    private void b(DownloadTask downloadTask) {
        ...
        StringBuilder m1016super = Cgoto.m1016super("tryCacheSameTaskWithListenerHashCode id:");
        m1016super.append(downloadTask.getDownloadId());
        m1016super.append(" listener hasCode:");
        m1016super.append(hashCodeForSameTask);
        com.ss.android.socialbase.downloader.c.a.b("AbsDownloadEngine", m1016super.toString());
    ...
    private void a(DownloadTask downloadTask, boolean z) {
        ...
        if (downloadInfo.isEntityInvalid()) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("downloadInfo is Invalid, url is ");
            m1016super.append(downloadInfo.getUrl());
            m1016super.append(" name is ");
            m1016super.append(downloadInfo.getName());
            m1016super.append(" savePath is ");
            m1016super.append(downloadInfo.getSavePath());
            com.ss.android.socialbase.downloader.d.a.a(monitorDepend, downloadInfo, new BaseException(1003, m1016super.toString()), downloadInfo.getStatus());
            return;
        }
        boolean z2 = false;
        if (com.ss.android.socialbase.downloader.g.a.a(downloadInfo.getId()).a("no_net_opt", 0) == 1 && !com.ss.android.socialbase.downloader.i.f.c(com.ss.android.socialbase.downloader.downloader.c.N()) && !downloadInfo.isFirstDownload()) {
            new com.ss.android.socialbase.downloader.downloader.f(downloadTask, this.f11951a).a(new BaseException(1049, "network_not_available"));
            return;
        }
    ...
    public void c(final int i, final boolean z) {
        ...
        this.f11951a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.impls.a.4
    ...
    public void b(final int i, final boolean z) {
        ...
        this.f11951a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.impls.a.2
            @Override // java.lang.Runnable
            public void run() {
                com.ss.android.socialbase.downloader.notification.b.a().f(i);
            }
    ...
    public synchronized boolean a(int i, boolean z) {
        ...
        if (downloadTask != null) {
            if (!com.ss.android.socialbase.downloader.g.a.a(i).b("fix_on_cancel_call_twice", true)) {
                new com.ss.android.socialbase.downloader.downloader.f(downloadTask, this.f11951a).c();
            }
            ...
            this.f11951a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.impls.a.1
                @Override // java.lang.Runnable
                public void run() {
    ...
    public synchronized void a(int i, int i2, final IDownloadListener iDownloadListener, com.ss.android.socialbase.downloader.constants.f fVar, boolean z, boolean z2) {
        ...
        if (o != null) {
            ...
            if (z2 && downloadInfo != null && !a(i) && (fVar == com.ss.android.socialbase.downloader.constants.f.MAIN || fVar == com.ss.android.socialbase.downloader.constants.f.NOTIFICATION)) {
                ...
                if (z3) {
                    this.f11951a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.impls.a.6
                        @Override // java.lang.Runnable
                        public void run() {
                            if (iDownloadListener != null) {
