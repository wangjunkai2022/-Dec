...
public class g extends com.ss.android.socialbase.appdownloader.c.a {
    ...
    public static String f11687a = "g";

    /* loaded from: classes7.dex */
    public static class a implements k {

        /* renamed from: a  reason: collision with root package name */
        public Dialog f11690a;
    ...
    public l a(final Context context) {
        return new l() { // from class: com.ss.android.downloadlib.c.g.1
            ...
            @Override // com.ss.android.socialbase.appdownloader.c.l
            public k a() {
                this.c.a(new b.InterfaceC0132b() { // from class: com.ss.android.downloadlib.c.g.1.1
                ...
                com.ss.android.downloadlib.g.k.a(g.f11687a, "getThemedAlertDlgBuilder", null);
                this.c.a(3);
