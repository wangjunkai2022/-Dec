...
public class d {
    ...
    public static ExecutorService f11894a = new ThreadPoolExecutor(2, 2, 60, TimeUnit.SECONDS, new LinkedBlockingQueue(), new a("Download_OP_Thread"));
    public int c = 0;
    public volatile SparseArray<c> b = new SparseArray<>();

    public static void a(Runnable runnable) {
        f11894a.execute(runnable);
    }
