...
public class AdDownloadModel implements DownloadModel {
    ...
    public JSONObject toJson() {
        ...
        try {
            ...
            jSONObject.putOpt(ak.o, this.mPackageName);
            ...
            if (this.mExtra != null) {
                jSONObject.put(BaseConstants.EVENT_LABEL_EXTRA, this.mExtra);
            }
