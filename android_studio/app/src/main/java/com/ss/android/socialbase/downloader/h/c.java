                ...
                try {
                    try {
                        try {
                            ...
                            String str2 = f11891a;
                            com.ss.android.socialbase.downloader.c.a.d(str2, "downloadInner: retry throwable for " + e2.a());
                            if (this.n != com.ss.android.socialbase.downloader.constants.h.RUN_STATUS_PAUSE) {
                                if (this.e != null && this.e.get() > 0) {
                                    ...
                                    if (this.p.trySwitchToNextBackupUrl()) {
                                        ...
                                        b(new BaseException((int) PointerIconCompat.TYPE_ZOOM_IN, String.format("retry for Throwable, but retry Time %s all used, last error is %s", String.valueOf(this.p.getRetryCount()), e2.a())));
                                    }
                                } else {
                            ...
                            String str3 = f11891a;
                            com.ss.android.socialbase.downloader.c.a.d(str3, "downloadInner: throwable =  " + th);
                            if (this.n != com.ss.android.socialbase.downloader.constants.h.RUN_STATUS_PAUSE) {
                        ...
                        String str4 = f11891a;
                        com.ss.android.socialbase.downloader.c.a.d(str4, "downloadInner: baseException = " + e3);
                        if (this.n != com.ss.android.socialbase.downloader.constants.h.RUN_STATUS_PAUSE) {
