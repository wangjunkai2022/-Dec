...
public class g {
    ...
    public static Handler f11904a = new Handler(Looper.getMainLooper());

    public static com.ss.android.socialbase.downloader.model.a a(final DownloadTask downloadTask) {
        if (downloadTask == null) {
            return null;
        }
        return new a.AbstractBinderC0174a() { // from class: com.ss.android.socialbase.downloader.i.g.1
            ...
            public com.ss.android.socialbase.downloader.depend.i b(int i) throws RemoteException {
                ...
                return g.a(singleDownloadListener, i != 1);
            }
            ...
            public com.ss.android.socialbase.downloader.depend.i a(int i, int i2) throws RemoteException {
                ...
                com.ss.android.socialbase.downloader.constants.f fVar = com.ss.android.socialbase.downloader.constants.f.SUB;
                return g.a(downloadListenerByIndex, i != 1);
            }
        };
    }
    ...
    public static com.ss.android.socialbase.downloader.depend.i a(final IDownloadListener iDownloadListener, final boolean z) {
        ...
        return new i.a() { // from class: com.ss.android.socialbase.downloader.i.g.12
            ...
            public void b(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.5
            ...
            public void c(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.6
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void d(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.7
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void e(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.8
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void f(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.10
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void g(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.11
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void h(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.12
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void i(final DownloadInfo downloadInfo) throws RemoteException {
                ...
                if (iDownloadListener2 instanceof s) {
                    if (z) {
                        g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.4
                            @Override // java.lang.Runnable
                            public void run() {
            ...
            public void a(final DownloadInfo downloadInfo) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.1
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void b(final DownloadInfo downloadInfo, final BaseException baseException) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.2
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void c(final DownloadInfo downloadInfo, final BaseException baseException) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.3
                        @Override // java.lang.Runnable
                        public void run() {
            ...
            public void a(final DownloadInfo downloadInfo, final BaseException baseException) throws RemoteException {
                if (z) {
                    g.f11904a.post(new Runnable() { // from class: com.ss.android.socialbase.downloader.i.g.12.9
                        @Override // java.lang.Runnable
                        public void run() {
    ...
    public static DownloadTask a(com.ss.android.socialbase.downloader.model.a aVar) {
        ...
        try {
            ...
            com.ss.android.socialbase.downloader.depend.i b = aVar.b(0);
            if (b != null) {
            ...
            com.ss.android.socialbase.downloader.depend.i b2 = aVar.b(1);
            if (b2 != null) {
            ...
            com.ss.android.socialbase.downloader.depend.i b3 = aVar.b(2);
            if (b3 != null) {
        ...
        return new m() { // from class: com.ss.android.socialbase.downloader.i.g.8
            ...
            public void a(DownloadInfo downloadInfo) throws BaseException {
                try {
                    ...
                    throw new BaseException((int) PointerIconCompat.TYPE_TEXT, e);
                }
            }
