...
public final class TypeAdapters {
    ...
    static {
        TypeAdapter<Class> nullSafe = new TypeAdapter<Class>() { // from class: com.google.gson.internal.bind.TypeAdapters.1
            ...
            public void write(JsonWriter jsonWriter, Class cls) throws IOException {
                StringBuilder m1016super = Cgoto.m1016super("Attempted to serialize java.lang.Class: ");
                m1016super.append(cls.getName());
                m1016super.append(". Forgot to register a type adapter?");
                throw new UnsupportedOperationException(m1016super.toString());
            }
        }.nullSafe();
        CLASS = nullSafe;
            ...
            */
            public java.util.BitSet read(com.google.gson.stream.JsonReader r7) throws java.io.IOException {
                ...
                L5b:
                    ...
                    java.lang.String r0 = com.apk.Cgoto.m989case(r0, r1)
                    r7.<init>(r0)
                    throw r7
                L67:
                    r7.endArray()
        ...
        CHARACTER = new TypeAdapter<Character>() { // from class: com.google.gson.internal.bind.TypeAdapters.15
            ...
            public Character read(JsonReader jsonReader) throws IOException {
                ...
                throw new JsonSyntaxException(Cgoto.m989case("Expecting character, got: ", nextString));
            }
            ...
            public void write(JsonWriter jsonWriter, JsonElement jsonElement) throws IOException {
                if (jsonElement != null && !jsonElement.isJsonNull()) {
                    if (jsonElement.isJsonPrimitive()) {
                        ...
                        StringBuilder m1016super = Cgoto.m1016super("Couldn't write ");
                        m1016super.append(jsonElement.getClass());
    ...
    public static <TT> TypeAdapterFactory newFactoryForMultipleTypes(final Class<TT> cls, final Class<? extends TT> cls2, final TypeAdapter<? super TT> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.34
            ...
            public String toString() {
                StringBuilder m1016super = Cgoto.m1016super("Factory[type=");
                m1016super.append(cls.getName());
                m1016super.append(BadgeDrawable.DEFAULT_EXCEED_MAX_BADGE_NUMBER_SUFFIX);
                m1016super.append(cls2.getName());
                m1016super.append(",adapter=");
                m1016super.append(typeAdapter);
                m1016super.append("]");
    ...
    public static <T1> TypeAdapterFactory newTypeHierarchyFactory(final Class<T1> cls, final TypeAdapter<T1> typeAdapter) {
        return new TypeAdapterFactory() { // from class: com.google.gson.internal.bind.TypeAdapters.35
                ...
                if (cls.isAssignableFrom(rawType)) {
                    return (TypeAdapter<T2>) new TypeAdapter<T1>() { // from class: com.google.gson.internal.bind.TypeAdapters.35.1
                        ...
                        public T1 read(JsonReader jsonReader) throws IOException {
                            ...
                            StringBuilder m1016super = Cgoto.m1016super("Expected a ");
                            m1016super.append(rawType.getName());
                            m1016super.append(" but was ");
                            m1016super.append(read.getClass().getName());
                            throw new JsonSyntaxException(m1016super.toString());
                        }
            ...
            public String toString() {
                StringBuilder m1016super = Cgoto.m1016super("Factory[typeHierarchy=");
                m1016super.append(cls.getName());
                m1016super.append(",adapter=");
                m1016super.append(typeAdapter);
                m1016super.append("]");
