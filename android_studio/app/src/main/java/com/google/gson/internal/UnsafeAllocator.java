    ...
    public static void assertInstantiable(Class<?> cls) {
        ...
        if (!Modifier.isInterface(modifiers)) {
            if (Modifier.isAbstract(modifiers)) {
                StringBuilder m1016super = Cgoto.m1016super("Abstract class can't be instantiated! Class name: ");
                m1016super.append(cls.getName());
                throw new UnsupportedOperationException(m1016super.toString());
            }
            return;
        }
        StringBuilder m1016super2 = Cgoto.m1016super("Interface can't be instantiated! Interface name: ");
        m1016super2.append(cls.getName());
        throw new UnsupportedOperationException(m1016super2.toString());
    }
