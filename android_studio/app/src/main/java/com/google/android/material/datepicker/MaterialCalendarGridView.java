            ...
            if (l != null) {
                if (pair.second == null) {
                    ...
                    while (itemId <= itemId2) {
                        ...
                        canvas.drawRect(numColumns > dayToPosition ? 0 : horizontalMidPoint, calendarStyle.day.getTopInset() + childAt.getTop(), dayToPosition2 > numColumns2 ? getWidth() : horizontalMidPoint2, childAt.getBottom() - calendarStyle.day.getBottomInset(), calendarStyle.rangeFill);
                        itemId++;
