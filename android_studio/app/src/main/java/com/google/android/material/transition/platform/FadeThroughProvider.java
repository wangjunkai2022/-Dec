...
public final class FadeThroughProvider implements VisibilityAnimatorProvider {
    ...
    public static Animator createFadeThroughAnimator(final View view, final float f, final float f2, @FloatRange(from = 0.0d, to = 1.0d) final float f3, @FloatRange(from = 0.0d, to = 1.0d) final float f4) {
