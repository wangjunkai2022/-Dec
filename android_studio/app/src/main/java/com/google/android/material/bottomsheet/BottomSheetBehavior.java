...
public class BottomSheetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
    ...
    public BottomSheetBehavior() {
        ...
        this.dragCallback = new ViewDragHelper.Callback() { // from class: com.google.android.material.bottomsheet.BottomSheetBehavior.4
            private boolean releasedLow(@NonNull View view) {
                ...
                return top2 > (bottomSheetBehavior.getExpandedOffset() + bottomSheetBehavior.parentHeight) / 2;
            }
    ...
    public void settleToState(@NonNull View view, int i) {
        ...
        if (i == 4) {
            ...
            throw new IllegalArgumentException(Cgoto.m1003implements("Illegal state argument: ", i));
        }
