...
public final class DecodedBitStreamParser {
    ...
    public static /* synthetic */ class AnonymousClass1 {
        ...
        static {
            ...
            try {
                int[] iArr2 = $SwitchMap$com$google$zxing$datamatrix$decoder$DecodedBitStreamParser$Mode;
                Mode mode2 = Mode.TEXT_ENCODE;
                iArr2[3] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                int[] iArr3 = $SwitchMap$com$google$zxing$datamatrix$decoder$DecodedBitStreamParser$Mode;
                Mode mode3 = Mode.ANSIX12_ENCODE;
                iArr3[4] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                int[] iArr4 = $SwitchMap$com$google$zxing$datamatrix$decoder$DecodedBitStreamParser$Mode;
                Mode mode4 = Mode.EDIFACT_ENCODE;
                iArr4[5] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                int[] iArr5 = $SwitchMap$com$google$zxing$datamatrix$decoder$DecodedBitStreamParser$Mode;
