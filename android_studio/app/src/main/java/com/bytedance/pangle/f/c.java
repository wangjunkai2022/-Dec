...
public final class c {
    ...
    public static class b {
        ...
        public final List<X509Certificate> f11324a;
    ...
    public static class C0117c {
        ...
        /* renamed from: a  reason: collision with root package name */
        public final X509Certificate[] f11325a;
        public final b b;
        public byte[] c;

        public C0117c(X509Certificate[] x509CertificateArr, b bVar) {
            this.f11325a = x509CertificateArr;
            this.b = bVar;
        }
    }

    public static C0117c a(RandomAccessFile randomAccessFile, m mVar) {
        ArrayMap arrayMap = new ArrayMap();
        try {
            CertificateFactory certificateFactory = CertificateFactory.getInstance("X.509");
            try {
                ByteBuffer a2 = f.a(mVar.f11333a);
                int i = 0;
                C0117c c0117c = null;
                while (a2.hasRemaining()) {
                    try {
                        c0117c = a(f.a(a2), arrayMap, certificateFactory);
                        i++;
                    } catch (a unused) {
                    } catch (IOException e) {
                        e = e;
                ...
                if (i == 1) {
                    if (!arrayMap.isEmpty()) {
                        ...
                        if (arrayMap.containsKey(3)) {
                            c0117c.c = f.a((byte[]) arrayMap.get(3), randomAccessFile.length(), mVar);
                        }
                        return c0117c;
                    }
    ...
    public static C0117c a(ByteBuffer byteBuffer, Map<Integer, byte[]> map, CertificateFactory certificateFactory) {
        ...
        while (true) {
            ...
            if (!a3.hasRemaining()) {
                ...
                try {
                    ...
                    throw new SecurityException(Cgoto.m989case(str, " signature did not verify"));
    ...
    public static C0117c a(ByteBuffer byteBuffer, List<X509Certificate> list, CertificateFactory certificateFactory) {
            ...
            if (a2.remaining() >= 4) {
                if (a2.getInt() == 1000370060) {
                    if (bVar == null) {
                        ...
                        try {
                            if (bVar.f11324a.size() > 0 && !Arrays.equals(bVar.f11324a.get(bVar.f11324a.size() - 1).getEncoded(), x509CertificateArr[0].getEncoded())) {
        ...
        return new C0117c(x509CertificateArr, bVar);
    }
