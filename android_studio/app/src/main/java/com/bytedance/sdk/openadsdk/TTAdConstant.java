...
public class TTAdConstant {
    ...
    public static final String BUILD_IN_MODULE_VERSION_NAME = "4.6.0.7";
    ...
    public static final String C_H = "4de8f8d";
    ...
    public static final String SDK_VERSION_NAME = "4.6.0.7";
