...
public class d {
    ...
    public static volatile String f11462a;
    ...
    static {
        try {
            f11462a = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).getPath();
    ...
    /* loaded from: classes8.dex */
    public static class C0125d implements k {

        /* renamed from: a  reason: collision with root package name */
        public final WeakReference<Context> f11467a;

        public C0125d(Context context) {
            this.f11467a = new WeakReference<>(context);
        }
        ...
        private DialogBuilder c(final com.ss.android.download.api.model.b bVar) {
            return DialogBuilder.builder().setTitle(bVar.b).setMessage(bVar.c).setNegativeBtnText(bVar.e).setPositiveBtnText(bVar.d).setIcon(bVar.g).setDialogStatusChangedListener(new IDialogStatusChangedListener() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.d.1
                ...
                public void onCancel(DialogInterface dialogInterface) {
                    b.InterfaceC0132b interfaceC0132b = bVar.h;
                    if (interfaceC0132b != null) {
                        interfaceC0132b.c(dialogInterface);
                    }
                }
                ...
                public void onNegativeBtnClick(DialogInterface dialogInterface) {
                    ...
                    if (interfaceC0132b != null) {
                        try {
                            interfaceC0132b.b(dialogInterface);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                ...
                public void onPositiveBtnClick(DialogInterface dialogInterface) {
                    b.InterfaceC0132b interfaceC0132b = bVar.h;
                    if (interfaceC0132b != null) {
                        interfaceC0132b.a(dialogInterface);
                    }
                }
            });
        }
        ...
        public void a(int i, Context context, DownloadModel downloadModel, String str, Drawable drawable, int i2) {
            try {
                ...
                StringBuilder m1016super = Cgoto.m1016super("showToastWithDuration e ");
                m1016super.append(e.getMessage());
                com.ss.android.socialbase.downloader.c.a.e("LibUIFactory", m1016super.toString());
            }
        }
        ...
        public AlertDialog b(com.ss.android.download.api.model.b bVar) {
            if (bVar != null && d.e() != null) {
                Context context = bVar.f11557a;
                if (context != null && (context instanceof Activity)) {
                    return d.e().showDialogBySelf((Activity) bVar.f11557a, bVar.j == 1, c(bVar));
                }
                d.e().showDialogByDelegate(this.f11467a, bVar.j == 1, c(bVar));
            }
            return null;
        }
    }
    ...
    public static boolean b(Context context) {
        ...
        com.ss.android.download.api.a a3 = a2.a(new c()).a(new a()).a(new C0125d(applicationContext)).a(new b()).a(new com.ss.android.download.api.config.i() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.3
        ...
        }).a(new a.C0131a().b("143").a(TTAdConstant.APP_NAME).c("4.6.0.7").d(String.valueOf(4607)).a()).a(new p() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.1
    ...
    public static boolean a(Activity activity, final ExitInstallListener exitInstallListener) {
        return com.ss.android.downloadlib.addownload.a.a.a().a(activity, false, new a.InterfaceC0137a() { // from class: com.bytedance.sdk.openadsdk.downloadnew.d.7
            @Override // com.ss.android.downloadlib.addownload.a.a.InterfaceC0137a
            public void a() {
