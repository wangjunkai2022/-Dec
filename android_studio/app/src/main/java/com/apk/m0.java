...
public class m0 {
    ...
    /* JADX WARN: Can't wrap try/catch for region: R(8:21|22|(2:24|(8:26|(3:32|(4:35|(8:37|38|39|40|41|42|43|(2:45|46)(2:48|49))(2:65|66)|47|33)|67)|68|(3:70|(4:72|(1:74)(2:84|(1:86)(1:87))|75|(2:79|80))(1:88)|81)|53|54|56|57))|89|53|54|56|57) */
    ...
    */
    ...
    public static boolean m1677catch(String str, List<WebSiteRulesBean> list) {
        ...
        int i = 0;
        try {
            JSONObject m2961super = x4.m2961super(str, 0L, xw.NO_CACHE);
            boolean optBoolean = m2961super.optBoolean(com.ss.android.socialbase.downloader.impls.h.e);
            try {
