jadx.core.utils.exceptions.JadxRuntimeException: Failed to generate code for class: com.wrapper.proxyapplication.MultiDexForMemoryDex
...
Caused by: jadx.core.utils.exceptions.CodegenException: Error generate insn: 0x0003: MOVE_RESULT  (r0v1 'i' int) =  in method: com.wrapper.proxyapplication.MultiDexForMemoryDex.getprefixname(java.lang.String):java.lang.String, file: classes5.dex
