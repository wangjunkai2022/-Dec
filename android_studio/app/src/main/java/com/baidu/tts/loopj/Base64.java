        ...
        public boolean process(byte[] bArr, int i, int i2, boolean z) {
            ...
            while (i9 < i4) {
                if (i8 == 0) {
                    while (true) {
                        int i10 = i9 + 4;
                        if (i10 > i4 || (i6 = (iArr[bArr[i9] & ExifInterface.MARKER] << 18) | (iArr[bArr[i9 + 1] & ExifInterface.MARKER] << 12) | (iArr[bArr[i9 + 2] & ExifInterface.MARKER] << 6) | iArr[bArr[i9 + 3] & ExifInterface.MARKER]) < 0) {
                            break;
                        }
                        bArr2[i7 + 2] = (byte) i6;
