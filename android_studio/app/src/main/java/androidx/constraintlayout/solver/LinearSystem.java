...
public class LinearSystem {
    ...
    private void displayRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            ...
            m1016super.append(this.mRows[i]);
            str = Cgoto.m989case(m1016super.toString(), "\n");
        }
        StringBuilder m1016super2 = Cgoto.m1016super(str);
        m1016super2.append(this.mGoal);
        m1016super2.append("\n");
        System.out.println(m1016super2.toString());
    }

    private void displaySolverVariables() {
        StringBuilder m1016super = Cgoto.m1016super("Display Rows (");
        m1016super.append(this.mNumRows);
        m1016super.append("x");
        System.out.println(Cgoto.m1019this(m1016super, this.mNumColumns, ")\n"));
    }
    ...
    private String getDisplaySize(int i) {
        ...
        int i4 = i3 / 1024;
        if (i4 > 0) {
            return Cgoto.m1005instanceof("", i4, " Mb");
        }
        if (i3 > 0) {
            return Cgoto.m1005instanceof("", i3, " Kb");
        }
        return Cgoto.m1005instanceof("", i2, " bytes");
    }
    ...
    public void displayReadableRows() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            StringBuilder m1016super = Cgoto.m1016super(str);
            m1016super.append(this.mRows[i].toReadableString());
            str = Cgoto.m989case(m1016super.toString(), "\n #  ");
        }
        if (this.mGoal != null) {
            StringBuilder m1016super2 = Cgoto.m1016super(str);
    ...
    public void displaySystemInformations() {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Linear System -> Table size: ");
        m1016super.append(this.TABLE_SIZE);
        m1016super.append(" (");
        int i5 = this.TABLE_SIZE;
        m1016super.append(getDisplaySize(i5 * i5));
        m1016super.append(") -- row sizes: ");
        m1016super.append(getDisplaySize(i));
        m1016super.append(", actual size: ");
        m1016super.append(getDisplaySize(i3));
        m1016super.append(" rows: ");
        m1016super.append(this.mNumRows);
        m1016super.append("/");
        m1016super.append(this.mMaxRows);
        m1016super.append(" cols: ");
        m1016super.append(this.mNumColumns);
        m1016super.append("/");
        m1016super.append(this.mMaxColumns);
        m1016super.append(" ");
        m1016super.append(0);
        m1016super.append(" occupied cells, ");
        m1016super.append(getDisplaySize(0));
