...
public final class NavUtils {
    ...
    public static void navigateUpFromSameTask(@NonNull Activity activity) {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Activity ");
        m1016super.append(activity.getClass().getSimpleName());
        m1016super.append(" does not have a parent activity name specified. (Did you forget to add the android.support.PARENT_ACTIVITY <meta-data>  element in your manifest?)");
