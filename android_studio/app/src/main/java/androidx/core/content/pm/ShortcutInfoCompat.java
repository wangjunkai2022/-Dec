...
public class ShortcutInfoCompat {
    ...
    private PersistableBundle buildLegacyExtrasBundle() {
        ...
        if (personArr != null && personArr.length > 0) {
            ...
            while (i < this.mPersons.length) {
                StringBuilder m1016super = Cgoto.m1016super(EXTRA_PERSON_);
                int i2 = i + 1;
                m1016super.append(i2);
                persistableBundle.putPersistableBundle(m1016super.toString(), this.mPersons[i].toPersistableBundle());
                i = i2;
            }
        }
    ...
    public static Person[] getPersonsFromExtra(@NonNull PersistableBundle persistableBundle) {
        ...
        while (i2 < i) {
            StringBuilder m1016super = Cgoto.m1016super(EXTRA_PERSON_);
            int i3 = i2 + 1;
            m1016super.append(i3);
            personArr[i2] = Person.fromPersistableBundle(persistableBundle.getPersistableBundle(m1016super.toString()));
            i2 = i3;
        }
        return personArr;
    }
