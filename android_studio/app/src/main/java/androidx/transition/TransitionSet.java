...
public class TransitionSet extends Transition {
    ...
    public TransitionSet setOrdering(int i) {
        if (i == 0) {
            ...
            throw new AndroidRuntimeException(Cgoto.m1003implements("Invalid parameter for TransitionSet ordering: ", i));
        }
        return this;
    }
    ...
    public String toString(String str) {
        ...
        for (int i = 0; i < this.mTransitions.size(); i++) {
            StringBuilder m1025while = Cgoto.m1025while(transition, "\n");
            m1025while.append(this.mTransitions.get(i).toString(str + "  "));
            transition = m1025while.toString();
        }
        return transition;
    }
