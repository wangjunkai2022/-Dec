...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public static /* synthetic */ class AnonymousClass7 {
        ...
        static {
            ...
            try {
                Adapter.StateRestorationPolicy stateRestorationPolicy = Adapter.StateRestorationPolicy.PREVENT;
                iArr[2] = 1;
            } catch (NoSuchFieldError unused) {
            }
            try {
                int[] iArr2 = $SwitchMap$androidx$recyclerview$widget$RecyclerView$Adapter$StateRestorationPolicy;
                Adapter.StateRestorationPolicy stateRestorationPolicy2 = Adapter.StateRestorationPolicy.PREVENT_WHEN_EMPTY;
                iArr2[1] = 2;
    ...
    public static abstract class LayoutManager {
        ...
        private void addViewInt(View view, int i, boolean z) {
            ...
            if (!childViewHolderInt.wasReturnedFromScrap() && !childViewHolderInt.isScrap()) {
                if (view.getParent() == this.mRecyclerView) {
                    ...
                    if (indexOfChild == -1) {
                        StringBuilder m1016super = Cgoto.m1016super("Added View has RecyclerView as parent but view is not a real child. Unfiltered index:");
                        m1016super.append(this.mRecyclerView.indexOfChild(view));
                        throw new IllegalStateException(Cgoto.m1011protected(this.mRecyclerView, m1016super));
        ...
        */
        ...
        public void ignoreView(@NonNull View view) {
            ...
            throw new IllegalArgumentException(Cgoto.m1011protected(this.mRecyclerView, Cgoto.m1016super("View should be fully attached to be ignored")));
        }
    ...
    public final class Recycler {
        ...
        public void bindViewToPosition(@NonNull View view, int i) {
            ...
            if (childViewHolderInt != null) {
                ...
                throw new IndexOutOfBoundsException(Cgoto.m1011protected(RecyclerView.this, sb));
            }
            throw new IllegalArgumentException(Cgoto.m1011protected(RecyclerView.this, Cgoto.m1016super("The view does not have a ViewHolder. You cannot pass arbitrary views to this method, they should be created by the Adapter")));
        }
        ...
        public int convertPreLayoutPositionToPostLayout(int i) {
            ...
            StringBuilder m1020throw = Cgoto.m1020throw("invalid position ", i, ". State item count is ");
            m1020throw.append(RecyclerView.this.mState.getItemCount());
            throw new IndexOutOfBoundsException(Cgoto.m1011protected(RecyclerView.this, m1020throw));
        }
        ...
        public ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z && (findHiddenNonRemovedView = RecyclerView.this.mChildHelper.findHiddenNonRemovedView(i)) != null) {
                ...
                throw new IllegalStateException(Cgoto.m1011protected(RecyclerView.this, sb));
            }
            int size2 = this.mCachedViews.size();
        ...
        public void recycleViewHolderInternal(ViewHolder viewHolder) {
            ...
            if (!viewHolder.isScrap() && viewHolder.itemView.getParent() == null) {
                if (!viewHolder.isTmpDetached()) {
                    ...
                    throw new IllegalArgumentException(Cgoto.m1011protected(RecyclerView.this, Cgoto.m1016super("Trying to recycle an ignored view holder. You should first call stopIgnoringView(view) before calling recycle.")));
                }
                StringBuilder sb = new StringBuilder();
                sb.append("Tmp detached view should be removed from RecyclerView before it can be recycled: ");
                sb.append(viewHolder);
                throw new IllegalArgumentException(Cgoto.m1011protected(RecyclerView.this, sb));
            }
            StringBuilder m1016super = Cgoto.m1016super("Scrapped or attached views may not be recycled. isScrap:");
            m1016super.append(viewHolder.isScrap());
            m1016super.append(" isAttached:");
            m1016super.append(viewHolder.itemView.getParent() != null);
            throw new IllegalArgumentException(Cgoto.m1011protected(RecyclerView.this, m1016super));
        }
        ...
        public void scrapView(View view) {
            ...
            if (!childViewHolderInt.hasAnyOfTheFlags(12) && childViewHolderInt.isUpdated() && !RecyclerView.this.canReuseUpdatedViewHolder(childViewHolderInt)) {
                ...
                throw new IllegalArgumentException(Cgoto.m1011protected(RecyclerView.this, Cgoto.m1016super("Called scrap view with an invalid view. Invalid views cannot be reused from scrap, they should rebound from recycler pool.")));
            } else {
    ...
    public static class State {
        ...
        public void assertLayoutStep(int i) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Layout state should be one of ");
            m1016super.append(Integer.toBinaryString(i));
            m1016super.append(" but it is ");
            m1016super.append(Integer.toBinaryString(this.mLayoutStep));
        ...
        public String toString() {
            StringBuilder m1016super = Cgoto.m1016super("State{mTargetPosition=");
            m1016super.append(this.mTargetPosition);
            m1016super.append(", mData=");
            m1016super.append(this.mData);
            m1016super.append(", mItemCount=");
            m1016super.append(this.mItemCount);
            m1016super.append(", mIsMeasuring=");
            m1016super.append(this.mIsMeasuring);
            m1016super.append(", mPreviousLayoutItemCount=");
            m1016super.append(this.mPreviousLayoutItemCount);
            m1016super.append(", mDeletedInvisibleItemCountSincePreviousLayout=");
            m1016super.append(this.mDeletedInvisibleItemCountSincePreviousLayout);
            m1016super.append(", mStructureChanged=");
            m1016super.append(this.mStructureChanged);
            m1016super.append(", mInPreLayout=");
            m1016super.append(this.mInPreLayout);
            m1016super.append(", mRunSimpleAnimations=");
            m1016super.append(this.mRunSimpleAnimations);
            m1016super.append(", mRunPredictiveAnimations=");
            m1016super.append(this.mRunPredictiveAnimations);
            m1016super.append('}');
    ...
    public static abstract class ViewHolder {
        ...
        public String toString() {
            StringBuilder m1025while = Cgoto.m1025while(getClass().isAnonymousClass() ? "ViewHolder" : getClass().getSimpleName(), "{");
            m1025while.append(Integer.toHexString(hashCode()));
            m1025while.append(" position=");
            m1025while.append(this.mPosition);
            m1025while.append(" id=");
            m1025while.append(this.mItemId);
            m1025while.append(", oldPos=");
            m1025while.append(this.mOldPosition);
            m1025while.append(", pLpos:");
            m1025while.append(this.mPreLayoutPosition);
            StringBuilder sb = new StringBuilder(m1025while.toString());
            if (isScrap()) {
                sb.append(" scrap ");
            ...
            if (!isRecyclable()) {
                StringBuilder m1016super = Cgoto.m1016super(" not recyclable(");
                m1016super.append(this.mIsRecyclableCount);
                m1016super.append(")");
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            if (childViewHolderInt != viewHolder && getChangedHolderKey(childViewHolderInt) == j) {
                ...
                if (adapter != null && adapter.hasStableIds()) {
                    ...
                    sb.append(" \n View Holder 2:");
                    sb.append(viewHolder);
                    throw new IllegalStateException(Cgoto.m1011protected(this, sb));
                }
                ...
                throw new IllegalStateException(Cgoto.m1011protected(this, sb2));
            }
        }
    ...
    private boolean isPreferredNextFocus(View view, View view2, int i) {
        ...
        if (i == 1) {
            ...
            sb.append(i);
            throw new IllegalArgumentException(Cgoto.m1011protected(this, sb));
        }
    }
    ...
    */
    ...
    public void assertInLayoutOrScroll(String str) {
        ...
        if (str == null) {
            throw new IllegalStateException(Cgoto.m1011protected(this, Cgoto.m1016super("Cannot call this method unless RecyclerView is computing a layout or scrolling")));
        }
        throw new IllegalStateException(Cgoto.m1011protected(this, Cgoto.m1016super(str)));
    }

    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            if (str == null) {
                throw new IllegalStateException(Cgoto.m1011protected(this, Cgoto.m1016super("Cannot call this method while RecyclerView is computing a layout or scrolling")));
            }
            throw new IllegalStateException(str);
        } else if (this.mDispatchScrollCounter > 0) {
            new IllegalStateException(Cgoto.m1011protected(this, Cgoto.m1016super("")));
        }
    }
    ...
    public String exceptionLabel() {
        ...
        m1016super.append(super.toString());
        m1016super.append(", adapter:");
        m1016super.append(this.mAdapter);
        m1016super.append(", layout:");
        m1016super.append(this.mLayout);
        m1016super.append(", context:");
        m1016super.append(getContext());
        return m1016super.toString();
    }
    ...
    */
    ...
    public ViewGroup.LayoutParams generateDefaultLayoutParams() {
        ...
        throw new IllegalStateException(Cgoto.m1011protected(this, Cgoto.m1016super("RecyclerView has no LayoutManager")));
    }
    ...
    public void initFastScroller(StateListDrawable stateListDrawable, Drawable drawable, StateListDrawable stateListDrawable2, Drawable drawable2) {
        ...
        throw new IllegalArgumentException(Cgoto.m1011protected(this, Cgoto.m1016super("Trying to set fast scroller without both required drawables.")));
    }
    ...
    public void setLayoutManager(@Nullable LayoutManager layoutManager) {
        ...
        if (layoutManager != null) {
            if (layoutManager.mRecyclerView == null) {
                ...
                throw new IllegalArgumentException(Cgoto.m1011protected(layoutManager.mRecyclerView, sb));
            }
        }
        this.mRecycler.updateViewCacheSize();
        requestLayout();
