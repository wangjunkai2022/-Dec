    ...
    */
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Provided int[]'s size must be more than or equal to span count. Expected:");
            m1016super.append(this.mSpanCount);
            m1016super.append(", array size:");
            m1016super.append(iArr.length);
    ...
    public static class LazySpanLookup {
        ...
        public static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder m1016super = Cgoto.m1016super("FullSpanItem{mPosition=");
                m1016super.append(this.mPosition);
                m1016super.append(", mGapDir=");
                m1016super.append(this.mGapDir);
                m1016super.append(", mHasUnwantedGapAfter=");
                m1016super.append(this.mHasUnwantedGapAfter);
                m1016super.append(", mGapPerSpan=");
                m1016super.append(Arrays.toString(this.mGapPerSpan));
                m1016super.append('}');
