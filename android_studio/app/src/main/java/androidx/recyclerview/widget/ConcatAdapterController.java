...
public class ConcatAdapterController implements NestedAdapterWrapper.Callback {
    ...
    private WrapperAndLocalPosition findWrapperAndLocalPosition(int i) {
        ...
        throw new IllegalArgumentException(Cgoto.m1003implements("Cannot find wrapper for ", i));
    }
    ...
    public boolean addAdapter(int i, RecyclerView.Adapter<RecyclerView.ViewHolder> adapter) {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Index must be between 0 and ");
        m1016super.append(this.mWrappers.size());
        m1016super.append(". Given:");
        m1016super.append(i);
