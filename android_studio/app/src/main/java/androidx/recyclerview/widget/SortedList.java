...
public class SortedList<T> {
    ...
    private void addToData(int i, T t) {
        ...
        StringBuilder m1020throw = Cgoto.m1020throw("cannot add item to ", i, " because size is ");
        m1020throw.append(this.mSize);
    ...
    public T get(int i) throws IndexOutOfBoundsException {
        ...
        StringBuilder m1020throw = Cgoto.m1020throw("Asked to get item at ", i, " but size is ");
        m1020throw.append(this.mSize);
        throw new IndexOutOfBoundsException(m1020throw.toString());
    }
