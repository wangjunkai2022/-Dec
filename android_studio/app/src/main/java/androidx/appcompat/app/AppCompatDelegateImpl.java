...
public class AppCompatDelegateImpl extends AppCompatDelegate implements MenuBuilder.Callback, LayoutInflater.Factory2 {
    ...
    private ViewGroup createSubDecor() {
        ...
        if (obtainStyledAttributes.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("AppCompat does not support the current theme features: { windowActionBar: ");
            m1016super.append(this.mHasActionBar);
            m1016super.append(", windowActionBarOverlay: ");
            m1016super.append(this.mOverlayActionBar);
            m1016super.append(", android:windowIsFloating: ");
            m1016super.append(this.mIsFloating);
            m1016super.append(", windowActionModeOverlay: ");
            m1016super.append(this.mOverlayActionMode);
            m1016super.append(", windowNoTitle: ");
            m1016super.append(this.mWindowNoTitle);
            m1016super.append(" }");
    ...
    public static Configuration generateConfigDelta(@NonNull Configuration configuration, @Nullable Configuration configuration2) {
        ...
        if (configuration2 != null && configuration.diff(configuration2) != 0) {
            ...
            int i23 = configuration.screenLayout & UMWorkDispatch.MSG_SEND_EVENT;
            int i24 = configuration2.screenLayout;
            if (i23 != (i24 & UMWorkDispatch.MSG_SEND_EVENT)) {
                configuration3.screenLayout |= i24 & UMWorkDispatch.MSG_SEND_EVENT;
            }
