...
public final class BackStackRecord extends FragmentTransaction implements FragmentManager.BackStackEntry, FragmentManagerImpl.OpGenerator {
        ...
        if (this.mAddToBackStack) {
            ...
            for (int i2 = 0; i2 < size; i2++) {
                ...
                if (fragment != null) {
                    ...
                    if (FragmentManagerImpl.DEBUG) {
                        StringBuilder m1016super = Cgoto.m1016super("Bump nesting of ");
                        m1016super.append(op.mFragment);
                        m1016super.append(" to ");
                        m1016super.append(op.mFragment.mBackStackNesting);
                        m1016super.toString();
                    }
                }
            }
    ...
    public FragmentTransaction detach(@NonNull Fragment fragment) {
        ...
        if (fragmentManagerImpl != null && fragmentManagerImpl != this.mManager) {
            StringBuilder m1016super = Cgoto.m1016super("Cannot detach Fragment attached to a different FragmentManager. Fragment ");
            m1016super.append(fragment.toString());
            m1016super.append(" is already attached to a FragmentManager.");
    ...
    public void executeOps() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 2:
                default:
                    StringBuilder m1016super = Cgoto.m1016super("Unknown cmd: ");
                    m1016super.append(op.mCmd);
    ...
    public FragmentTransaction hide(@NonNull Fragment fragment) {
        FragmentManagerImpl fragmentManagerImpl = fragment.mFragmentManager;
        if (fragmentManagerImpl != null && fragmentManagerImpl != this.mManager) {
            StringBuilder m1016super = Cgoto.m1016super("Cannot hide Fragment attached to a different FragmentManager. Fragment ");
            m1016super.append(fragment.toString());
            m1016super.append(" is already attached to a FragmentManager.");
            throw new IllegalStateException(m1016super.toString());
        }
    ...
    public FragmentTransaction remove(@NonNull Fragment fragment) {
        FragmentManagerImpl fragmentManagerImpl = fragment.mFragmentManager;
        if (fragmentManagerImpl != null && fragmentManagerImpl != this.mManager) {
            StringBuilder m1016super = Cgoto.m1016super("Cannot remove Fragment attached to a different FragmentManager. Fragment ");
            m1016super.append(fragment.toString());
            m1016super.append(" is already attached to a FragmentManager.");
            throw new IllegalStateException(m1016super.toString());
        }
    ...
    public FragmentTransaction setMaxLifecycle(@NonNull Fragment fragment, @NonNull Lifecycle.State state) {
        if (fragment.mFragmentManager == this.mManager) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Cannot set maximum Lifecycle below ");
            m1016super.append(Lifecycle.State.CREATED);
            throw new IllegalArgumentException(m1016super.toString());
        }
        StringBuilder m1016super2 = Cgoto.m1016super("Cannot setMaxLifecycle for Fragment not attached to FragmentManager ");
        m1016super2.append(this.mManager);
    ...
    public FragmentTransaction setPrimaryNavigationFragment(@Nullable Fragment fragment) {
        ...
        if (fragment != null && (fragmentManagerImpl = fragment.mFragmentManager) != null && fragmentManagerImpl != this.mManager) {
            StringBuilder m1016super = Cgoto.m1016super("Cannot setPrimaryNavigation for Fragment attached to a different FragmentManager. Fragment ");
            m1016super.append(fragment.toString());
            m1016super.append(" is already attached to a FragmentManager.");
            throw new IllegalStateException(m1016super.toString());
        }
    ...
    public FragmentTransaction show(@NonNull Fragment fragment) {
        FragmentManagerImpl fragmentManagerImpl = fragment.mFragmentManager;
        if (fragmentManagerImpl != null && fragmentManagerImpl != this.mManager) {
            StringBuilder m1016super = Cgoto.m1016super("Cannot show Fragment attached to a different FragmentManager. Fragment ");
            m1016super.append(fragment.toString());
            m1016super.append(" is already attached to a FragmentManager.");
            throw new IllegalStateException(m1016super.toString());
        }
        ...
        for (int i = 0; i < size; i++) {
            ...
            switch (op.mCmd) {
                ...
                case 10:
                    ...
                    break;
                default:
                    StringBuilder m1016super = Cgoto.m1016super("cmd=");
                    m1016super.append(op.mCmd);
                    str2 = m1016super.toString();
                    break;
            }
            printWriter.print(str);
