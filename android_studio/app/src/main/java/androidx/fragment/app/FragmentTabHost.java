...
public class FragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder m1016super = Cgoto.m1016super("FragmentTabHost.SavedState{");
            m1016super.append(Integer.toHexString(System.identityHashCode(this)));
            m1016super.append(" curTab=");
            return Cgoto.m991class(m1016super, this.curTab, "}");
        }
    ...
    private void ensureContent() {
        if (this.mRealTabContent == null) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("No tab content FrameLayout found for id ");
            m1016super.append(this.mContainerId);
