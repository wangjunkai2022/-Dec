...
public class PathInterpolatorCompat implements Interpolator {
    ...
    private void initPath(Path path) {
        ...
        if (min > 0) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("The Path must start at (0,0) and end at (1,1) start: ");
            m1016super.append(this.mX[0]);
            m1016super.append(",");
            m1016super.append(this.mY[0]);
            m1016super.append(" end:");
            int i6 = min - 1;
            m1016super.append(this.mX[i6]);
            m1016super.append(",");
            m1016super.append(this.mY[i6]);
    ...
    private void parseInterpolatorFromTypeArray(TypedArray typedArray, XmlPullParser xmlPullParser) {
        if (TypedArrayUtils.hasAttribute(xmlPullParser, "pathData")) {
            ...
            throw new InflateException(Cgoto.m989case("The path is null, which is created from ", namedString));
    ...
    public float getInterpolation(float f) {
        ...
        float[] fArr2 = this.mY;
        float f3 = fArr2[i];
        return Cgoto.m995do(fArr2[length], f3, (f - fArr[i]) / f2, f3);
    }
