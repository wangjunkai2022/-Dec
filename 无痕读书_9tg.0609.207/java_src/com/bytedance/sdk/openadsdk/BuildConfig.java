...
public final class BuildConfig {
    public static final String BRANCH = "v4600";
    public static final String BUILD_TYPE = "release";
    public static final String CHANNEL = "main";
    public static final String COMMIT_HASH = "4de8f8d";
    public static final boolean DEBUG = false;
    public static final boolean INCLUDE_LIVE = false;
    ...
    public static final int VERSION_CODE = 4607;
    public static final String VERSION_NAME = "4.6.0.7";
}
