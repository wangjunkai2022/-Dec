...
public class e extends a {
    ...
    public static volatile e f11470a;
    ...
    public <T> T callMethod(Class<T> cls, int i, Map<String, Object> map) {
        switch (i) {
            ...
            case 14:
                ...
                return (T) Boolean.valueOf(d.a().e().a(this.b, ((Long) map.get("id")).longValue(), (String) map.get(TTDownloadField.TT_LOG_EXTRA), (DownloadStatusChangeListener) null, intValue4));
            case 15:
