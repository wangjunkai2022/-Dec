...
public abstract class g {
    ...
    public static final byte[] f11328a = new byte[8];

    /* loaded from: classes8.dex */
    public static class a {

        /* renamed from: a  reason: collision with root package name */
        public final ByteBuffer f11329a;
        public final byte[] b;
    ...
    public static class b implements j {
        ...
        public final void a(ByteBuffer byteBuffer) {
            ...
            while (remaining > 0) {
                int min = Math.min(remaining, 4096 - this.f11330a);
                byteBuffer.limit(byteBuffer.position() + min);
                this.c.update(byteBuffer);
                remaining -= min;
                int i = this.f11330a + min;
                this.f11330a = i;
                if (i == 4096) {
        ...
        public final void a() {
            ...
            throw new IllegalStateException("Buffer is not empty: " + this.f11330a);
        }
    }
    ...
    public static a a(RandomAccessFile randomAccessFile, m mVar, i iVar) {
        ...
        if (j % 4096 == 0) {
            ...
            if ((j2 - j) % 4096 == 0) {
                ...
                if (a4 != null) {
                    wrap.put(a(randomAccessFile, mVar, f11328a, a7, a4));
                    wrap.flip();
                }
                if (a5 != null) {
    ...
    public static int[] a(long j) {
        ...
        while (i < arrayList.size()) {
            int i2 = i + 1;
            iArr[i2] = c(((Long) arrayList.get((arrayList.size() - i) - 1)).longValue()) + iArr[i];
            i = i2;
        }
        return iArr;
    }
