...
public final class b {
    ...
    public static boolean a(File file, String str, int i) {
        ...
        try {
            try {
                try {
                    ...
                    try {
                        if (e.a(file.getAbsolutePath(), str2)) {
                            ...
                            if (GlobalParam.getInstance().checkMatchHostAbi()) {
                                try {
                                    ...
                                    f11351a.a(ZeusPluginEventCallback.EVENT_FINISH_INSTALLATION, -5, str, i, e);
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    f11351a.a(ZeusPluginEventCallback.EVENT_FINISH_INSTALLATION, -8, str, i, e3);
                                    throw new a("dexOpt失败", e3, (byte) 0);
                                }
                            } catch (Exception e4) {
                                a(com.bytedance.pangle.b.b.f, b.a.t, str, i, -1L, null);
                                f11351a.a(ZeusPluginEventCallback.EVENT_FINISH_INSTALLATION, -7, str, i, e4);
                        ...
                        f11351a.a(ZeusPluginEventCallback.EVENT_FINISH_INSTALLATION, -3, str, i, e5);
            ...
            f11351a.a(ZeusPluginEventCallback.EVENT_FINISH_INSTALLATION, -1, str, i, e8);
            return false;
        }
    }
