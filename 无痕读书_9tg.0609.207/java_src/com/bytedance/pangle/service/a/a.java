...
public class a extends d.a {
    ...
    public final C0120a<Intent> e = new C0120a<>();
    ...
    public final Handler f11375a = new Handler(Looper.getMainLooper());

    /* renamed from: com.bytedance.pangle.service.a.a$a  reason: collision with other inner class name */
    /* loaded from: classes8.dex */
    public class C0120a<T> extends HashMap<f, T> {
        public C0120a() {
        }
    ...
    public final ComponentName a(final Intent intent, final String str) {
        ...
        this.f11375a.post(new Runnable() { // from class: com.bytedance.pangle.service.a.a.1
    ...
    public final boolean b(final Intent intent, String str) {
        ...
        this.f11375a.post(new Runnable() { // from class: com.bytedance.pangle.service.a.a.2
            @Override // java.lang.Runnable
            public final void run() {
    ...
    public final boolean a(final Intent intent, final f fVar, final int i, final String str) {
        ...
        this.f11375a.post(new Runnable() { // from class: com.bytedance.pangle.service.a.a.3
            @Override // java.lang.Runnable
            public final void run() {
                try {
    ...
    public final void a(final f fVar) {
        if (Looper.myLooper() == Looper.getMainLooper()) {
            ...
            this.f11375a.post(new Runnable() { // from class: com.bytedance.pangle.service.a.a.4
                @Override // java.lang.Runnable
                public final void run() {
                    a.this.b(fVar);
                }
