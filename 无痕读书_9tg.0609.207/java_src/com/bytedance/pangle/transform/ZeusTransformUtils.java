...
public class ZeusTransformUtils {
    ...
    public static void clearConstructorCache() {
        if (Build.VERSION.SDK_INT <= 23) {
            try {
                ...
                Iterator it = new HashSet(sConstructorMap.keySet()).iterator();
                while (it.hasNext()) {
    ...
    public static Context getWrapperFromCache(Object obj, String str) {
        ...
        m1016super.append(System.identityHashCode(obj));
        WeakReference<Context> weakReference = hashMap.get(m1016super.toString());
    ...
    public static Context wrapperContext(Object obj, String str) {
        ...
        if (pluginContext != null) {
            HashMap<String, WeakReference<Context>> hashMap = contextCache;
            StringBuilder m1016super = Cgoto.m1016super(str);
            m1016super.append(System.identityHashCode(contextIfNeedWrap));
            hashMap.put(m1016super.toString(), new WeakReference<>(pluginContext));
        }
