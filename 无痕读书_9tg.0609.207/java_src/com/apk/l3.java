                ...
                if (z) {
                    try {
                        ...
                        while (it2.hasNext()) {
                            ...
                            strArr2[0] = "collectId = ?";
                            strArr2[1] = next.getId();
                            if (((ComicCollectBean) LitePal.where(strArr2).findFirst(ComicCollectBean.class)) != null) {
                ...
                if (!comicCollectBean2.isLocalBook(comicCollectBean2.getFileType())) {
                    try {
                        ...
                        if (m3134super != null) {
                            ...
                            try {
                                strArr[1] = m3134super.getId();
                                LitePal.updateAll(ComicCollectBean.class, contentValues3, strArr);
                            } catch (Exception e8) {
                                e = e8;
                                e.printStackTrace();
                                mu.m1769if(comicCollectBean2.getCollectId());
