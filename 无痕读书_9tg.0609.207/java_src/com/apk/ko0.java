...
public class ko0 {
    ...
    public static final char[] f2617do = {',', ';'};

    /* renamed from: if  reason: not valid java name */
    public static final HashMap<String, String> f2618if = new HashMap<>();

    /* compiled from: Entities.java */
    /* renamed from: com.apk.ko0$do  reason: invalid class name */
    /* loaded from: classes7.dex */
    public enum Cdo {
        ascii,
        utf,
    ...
    /* compiled from: Entities.java */
    /* renamed from: com.apk.ko0$if  reason: invalid class name */
    /* loaded from: classes7.dex */
    public enum Cif {
        ...
        public String[] f2630new;

        Cif(String str, int i) {
            ko0.m1540do(this, str, i);
        }

        /* renamed from: do  reason: not valid java name */
        public int m1544do(String str) {
            int binarySearch = Arrays.binarySearch(this.f2627do, str);
            if (binarySearch >= 0) {
                return this.f2629if[binarySearch];
            }
            return -1;
        }
    }
    ...
    static {
        Cif cif = Cif.base;
        Charset charset = ao0.f128do;
        new ThreadLocal();
    }

    /* renamed from: do  reason: not valid java name */
    public static void m1540do(Cif cif, String str, int i) {
        int i2;
        cif.f2627do = new String[i];
        cif.f2629if = new int[i];
        cif.f2628for = new int[i];
        cif.f2630new = new String[i];
        qo0 qo0Var = new qo0(new StringReader(str), str.length());
        int i3 = 0;
        while (!qo0Var.m2171super()) {
            try {
                String m2173this = qo0Var.m2173this('=');
                qo0Var.m2156do();
                int parseInt = Integer.parseInt(qo0Var.m2150break(f2617do), 36);
                char m2154const = qo0Var.m2154const();
                qo0Var.m2156do();
                if (m2154const == ',') {
                    i2 = Integer.parseInt(qo0Var.m2173this(';'), 36);
                    qo0Var.m2156do();
                } else {
                    i2 = -1;
                }
                int parseInt2 = Integer.parseInt(qo0Var.m2173this('&'), 36);
                qo0Var.m2156do();
                cif.f2627do[i3] = m2173this;
                cif.f2629if[i3] = parseInt;
                cif.f2628for[parseInt2] = parseInt;
                cif.f2630new[parseInt2] = m2173this;
                if (i2 != -1) {
                    f2618if.put(m2173this, new String(new int[]{parseInt, i2}, 0, 2));
                }
                i3++;
            } finally {
                qo0Var.m2165new();
        ...
        sb0.m2423private(i3 == i, "Unexpected count of entities loaded");
    }

    /* renamed from: for  reason: not valid java name */
    public static void m1541for(Appendable appendable, String str, ho0.Cdo cdo, boolean z, boolean z2, boolean z3) throws IOException {
        Cif cif = cdo.f1912do;
        CharsetEncoder charsetEncoder = cdo.f1914for.get();
        if (charsetEncoder == null) {
            charsetEncoder = cdo.m1149if();
        }
        Cdo cdo2 = cdo.f1917new;
        ...
        while (i < length) {
            ...
            if (codePointAt < 65536) {
                ...
                if (c == '\t' || c == '\n' || c == '\r') {
                    ...
                    if (c == '&') {
                        ...
                        if (c != '>') {
                            if (c != 160) {
                                ...
                                m1542if(appendable, cif, codePointAt);
                            } else if (cif != Cif.xhtml) {
                                appendable.append("&nbsp;");
                            } else {
                                appendable.append("&#xa0;");
                            }
                    ...
                    } else if (z && cif != Cif.xhtml && cdo.f1915goto != ho0.Cdo.EnumC0066do.xml) {
                        appendable.append(c);
                    } else {
                        appendable.append("&lt;");
                    }
    ...
    /* renamed from: if  reason: not valid java name */
    public static void m1542if(Appendable appendable, Cif cif, int i) throws IOException {
        CharSequence charSequence;
        int binarySearch = Arrays.binarySearch(cif.f2628for, i);
        if (binarySearch >= 0) {
            CharSequence[] charSequenceArr = cif.f2630new;
            if (binarySearch < charSequenceArr.length - 1) {
                int i2 = binarySearch + 1;
                if (cif.f2628for[i2] == i) {
                    charSequence = charSequenceArr[i2];
                }
            }
            charSequence = cif.f2630new[binarySearch];
        } else {
            charSequence = "";
        }
    ...
    /* renamed from: new  reason: not valid java name */
    public static boolean m1543new(String str) {
        return Cif.base.m1544do(str) != -1;
    }
}
