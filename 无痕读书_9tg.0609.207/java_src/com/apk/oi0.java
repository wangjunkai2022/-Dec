        ...
        while (xh0Var4 != null) {
            ...
            if (xh0Var4.f5616this == null) {
                ...
                if (z2) {
                    ...
                    String str = tg0Var.f4689try;
                    int i3 = tg0Var.f4681case;
                    xg0 xg0Var2 = xh0Var4.f5617throw;
                    xc0Var = xc0Var2;
                    i = i2;
                    ch0Var = ch0Var2;
                    uf0 uf0Var = new uf0(str, i3, xg0Var2.f5547class, xg0Var2.f5569throw, sSLSocketFactory, hostnameVerifier, bg0Var, xg0Var2.f5566super, xg0Var2.f5548const, xg0Var2.f5563public, xg0Var2.f5559native, xg0Var2.f5553final);
                ...
                try {
                    if (!xh0Var4.f5606const) {
                        try {
                            mo1721do = mi0Var2.mo1721do(zg0Var2);
                            if (ch0Var != null) {
                                try {
                                    nd0.m1875new(mo1721do, "response");
                                    zg0 zg0Var3 = mo1721do.f615if;
                                    yg0 yg0Var = mo1721do.f613for;
                                    int i4 = mo1721do.f618try;
                                    String str2 = mo1721do.f616new;
                                    rg0 rg0Var = mo1721do.f606case;
                                    sg0.Cdo m2454for = mo1721do.f611else.m2454for();
                                    dh0 dh0Var = mo1721do.f614goto;
                                    ch0 ch0Var3 = mo1721do.f617this;
                                    ch0 ch0Var4 = mo1721do.f605break;
                                    long j = mo1721do.f608class;
                                    mi0Var = mi0Var2;
                                    xh0Var2 = xh0Var4;
                                    try {
                                        long j2 = mo1721do.f609const;
                                        vh0 vh0Var2 = mo1721do.f612final;
                                        ch0 ch0Var5 = ch0Var;
                                        ...
                                        if (!(i5 >= 0)) {
                                            ...
                                            if (str3 != null) {
                                                ch0 ch0Var9 = new ch0(zg0Var4, yg0Var2, str3, i5, rg0Var2, m2454for2.m2462new(), null, ch0Var6, ch0Var7, ch0Var8, j3, j4, vh0Var3);
                                                if (!(ch0Var9.f614goto == null)) {
                                                    throw new IllegalArgumentException("priorResponse.body != null".toString());
                                                }
                                                if (!(i4 >= 0)) {
                                                    throw new IllegalStateException(("code < 0: " + i4).toString());
                                                } else if (zg0Var3 == null) {
                                                    throw new IllegalStateException("request == null".toString());
                                                } else {
                                                    if (yg0Var == null) {
                                                        throw new IllegalStateException("protocol == null".toString());
                                                    ...
                                                    if (str2 != null) {
                                                        mo1721do = new ch0(zg0Var3, yg0Var, str2, i4, rg0Var, m2454for.m2462new(), dh0Var, ch0Var3, ch0Var4, ch0Var9, j, j2, vh0Var2);
                                                    } else {
                            ...
                            try {
                                zg0Var2 = oi0Var.m1961if(mo1721do, vh0Var);
                            } catch (Throwable th6) {
                                th = th6;
                                xh0Var.m3001else(true);
                                throw th;
                            ...
                            ch0 ch0Var10 = ch0Var;
                            oi0Var = this;
                            if (oi0Var.m1960for(e.f1070do, xh0Var, zg0Var2, false)) {
                            ...
                            ch0 ch0Var11 = ch0Var;
                            oi0Var = this;
                            if (oi0Var.m1960for(e2, xh0Var, zg0Var2, !(e2 instanceof si0))) {
                                xc0 xc0Var4 = xc0Var;
