...
public class f {
    ...
    public static Handler f11676a = new Handler(Looper.getMainLooper());
    ...
    public static long e(com.ss.android.downloadad.api.a.b bVar) {
        return bVar == null ? TooltipCompatHandler.HOVER_HIDE_TIMEOUT_SHORT_MS : com.ss.android.downloadlib.g.e.a(bVar).a("app_link_opt_back_time_limit", 3) * 1000;
    }
    ...
    public static void a(final com.ss.android.downloadad.api.a.b bVar, @NonNull final h hVar) {
        ...
        com.ss.android.socialbase.downloader.a.a.a().a(new a.InterfaceC0150a() { // from class: com.ss.android.downloadlib.b.f.1
