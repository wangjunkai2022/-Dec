...
public class h {
    public static void b(final Context context, final com.ss.android.downloadlib.addownload.b.e eVar, final String str) {
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.g.h.1
            ...
            public void run() {
                ...
                final String optString = i.optString(ak.aB);
                final JSONObject jSONObject = new JSONObject();
                String a2 = com.ss.android.socialbase.appdownloader.f.c.a(i.optString("x"), optString);
                JSONObject jSONObject2 = new JSONObject();
                l.a(jSONObject2, ak.ax, str);
                l.a(jSONObject2, ak.aC, Build.VERSION.INCREMENTAL);
                ...
                l.a(jSONObject2, ak.aH, PaintCompat.EM_STRING);
                byte[] bytes = jSONObject2.toString().getBytes();
                com.ss.android.downloadlib.addownload.j.d().a(a2, com.ss.android.downloadlib.addownload.j.q().a(bytes, bytes.length), "application/octet-stream;tt-data=a", 0, new q() { // from class: com.ss.android.downloadlib.g.h.1.1
                    ...
                    public void a(Throwable th) {
                        ...
                        com.ss.android.downloadlib.b.a.a(h.a(context2, Uri.parse(m1016super.toString())), eVar, true);
    ...
    public static com.ss.android.downloadlib.addownload.b.g c(Context context, com.ss.android.downloadlib.addownload.b.e eVar, String str) {
        ...
        intent.putExtra("id", eVar.f11597a);
        ...
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.g.h.2
            ...
            public void run() {
                ...
                try {
                    ...
                    bVar.f11574a = 1;
                    bVar.b = 0;
                    bVar.c = String.format(com.ss.android.socialbase.appdownloader.f.c.a(i.optString(ak.aE), i.optString(ak.aB)), str);
    ...
    public static void b(Context context, String str, String str2, @NonNull com.ss.android.downloadlib.addownload.b.e eVar, @NonNull JSONObject jSONObject) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(a2)) {
                TTDelegateActivity.a(str, eVar.f11597a, a2, jSONObject);
            } else {
                com.ss.android.downloadlib.b.a.a(a(context, Uri.parse(BaseConstants.MARKET_PREFIX + str)), eVar, true);
    ...
    public static void e(final Context context, final com.ss.android.downloadlib.addownload.b.e eVar, final String str) {
        com.ss.android.downloadlib.d.a().a(new Runnable() { // from class: com.ss.android.downloadlib.g.h.3
            ...
            public void run() {
                ...
                String a2 = com.ss.android.socialbase.appdownloader.f.c.a(i.optString("x"), optString);
                JSONObject jSONObject2 = new JSONObject();
                l.a(jSONObject2, ak.aH, ak.aE);
                l.a(jSONObject2, ak.ax, str);
                byte[] bytes = jSONObject2.toString().getBytes();
                com.ss.android.downloadlib.addownload.j.d().a(a2, com.ss.android.downloadlib.addownload.j.q().a(bytes, bytes.length), "application/octet-stream;tt-data=a", 0, new q() { // from class: com.ss.android.downloadlib.g.h.3.1
                    @Override // com.ss.android.download.api.config.q
                    public void a(String str2) {
    ...
    public static String a(String str, @NonNull JSONObject jSONObject, String str2) {
        ...
        String a3 = com.ss.android.socialbase.appdownloader.f.c.a(jSONObject.optString(com.ss.android.socialbase.downloader.impls.h.e), str2);
    ...
    public static void a(Context context, String str, long j, boolean z) {
        ...
        try {
            JSONObject i = com.ss.android.downloadlib.addownload.j.i();
            String optString = i.optString(ak.aB);
            String a2 = com.ss.android.socialbase.appdownloader.f.c.a(i.optString("aa"), optString);
            String a3 = com.ss.android.socialbase.appdownloader.f.c.a(i.optString("ac"), optString);
            String a4 = com.ss.android.socialbase.appdownloader.f.c.a(i.optString("af"), optString);
            boolean a5 = com.ss.android.socialbase.appdownloader.f.a.a(i, context, a3);
    ...
    public static void a(@NonNull Activity activity, String str, long j, String str2, String str3) {
        ...
        try {
            ...
            boolean a2 = com.ss.android.socialbase.appdownloader.f.a.a(i2, activity, com.ss.android.socialbase.appdownloader.f.c.a(i2.optString("bg"), i2.optString(ak.aB)));
