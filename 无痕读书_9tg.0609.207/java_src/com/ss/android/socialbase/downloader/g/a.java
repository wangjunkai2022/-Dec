...
public class a {
    ...
    public static final h<Integer, a> f11888a = new h<>(16, 16);
    ...
    public static void b(int i) {
        ...
        synchronized (f11888a) {
            f11888a.remove(Integer.valueOf(i));
        }
    }
    ...
    public static a a(int i, DownloadInfo downloadInfo) {
        ...
        if (aVar2 == null || aVar2.k != i) {
            synchronized (f11888a) {
                aVar = f11888a.get(Integer.valueOf(i));
            }
            if (aVar == null) {
                aVar = downloadInfo == null ? c(i) : b(downloadInfo);
                synchronized (f11888a) {
                    f11888a.put(Integer.valueOf(i), aVar);
                }
            }
            aVar.k = i;
            g = aVar;
    ...
    public static void a(int i, JSONObject jSONObject) {
        ...
        synchronized (f11888a) {
            ...
            if (aVar != null && aVar.h == jSONObject) {
                ...
                aVar = null;
                Iterator<a> it = f11888a.values().iterator();
                while (true) {
                    if (!it.hasNext()) {
                        break;
                    }
