...
public class o implements com.ss.android.socialbase.downloader.downloader.m, com.ss.android.socialbase.downloader.downloader.n {
    ...
    public static final String f11970a = "o";
    ...
    public boolean b() {
        if (this.b == null) {
            com.ss.android.socialbase.downloader.c.a.d(f11970a, "isServiceForeground, aidlService is null");
            return false;
        }
        com.ss.android.socialbase.downloader.c.a.c(f11970a, "aidlService.isServiceForeground");
        try {
            return this.b.f();
        } catch (RemoteException e) {
            e.printStackTrace();
    ...
    public void a(int i, Notification notification) {
        if (this.b == null) {
            com.ss.android.socialbase.downloader.c.a.d(f11970a, "startForeground, aidlService is null");
            return;
        }
        String str = f11970a;
    ...
    public void a(boolean z, boolean z2) {
        if (this.b == null) {
            com.ss.android.socialbase.downloader.c.a.d(f11970a, "stopForeground, aidlService is null");
            return;
        }
        com.ss.android.socialbase.downloader.c.a.c(f11970a, "aidlService.stopForeground");
        try {
            this.b.a(z2);
        } catch (RemoteException e) {
            e.printStackTrace();
