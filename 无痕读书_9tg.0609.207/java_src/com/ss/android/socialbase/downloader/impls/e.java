...
public class e extends a {
    ...
    public static Runnable e(List<Future> list) {
        ...
        if (list != null && !list.isEmpty()) {
            try {
                ...
                StringBuilder m1016super = Cgoto.m1016super("getUnstartedTask() error: ");
                m1016super.append(th.toString());
                com.ss.android.socialbase.downloader.c.a.d("DefaultDownloadEngine", m1016super.toString());
            }
        }
        return null;
    }
    ...
    public void a(int i, DownloadTask downloadTask) {
        ...
        b.a(new com.ss.android.socialbase.downloader.h.c(downloadTask, this.f11951a));
    }
