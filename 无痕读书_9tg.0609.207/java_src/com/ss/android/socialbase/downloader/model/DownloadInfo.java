...
public class DownloadInfo implements Parcelable {
    ...
    public boolean canReplaceHttpForRetry() {
        return !TextUtils.isEmpty(this.url) && this.url.startsWith(SpeechSynthesizer.REQUEST_PROTOCOL_HTTPS) && this.needHttpsToHttpRetry && !this.httpsToHttpRetryUsed;
    }
    ...
    public String getConnectionUrl() {
        ...
        if (!this.backUpUrlUsed || (list = this.backUpUrls) == null || list.size() <= 0 || (i = this.curBackUpUrlIndex) < 0 || i >= this.backUpUrls.size()) {
            return (!TextUtils.isEmpty(this.url) && this.url.startsWith(SpeechSynthesizer.REQUEST_PROTOCOL_HTTPS) && this.needHttpsToHttpRetry && this.httpsToHttpRetryUsed) ? this.url.replaceFirst(SpeechSynthesizer.REQUEST_PROTOCOL_HTTPS, SpeechSynthesizer.REQUEST_PROTOCOL_HTTP) : str;
        }
    ...
    public long getMinByteIntervalForPostToMainThread(long j) {
        ...
        long j2 = j / (i + 1);
        return j2 <= 0 ? DEFAULT_MIN_BYTES_INTERVAL : j2;
    }
    ...
    public boolean isExpiredRedownload() {
        if (com.ss.android.socialbase.downloader.g.a.c().a("force_close_download_cache_check", 0) == 1) {
            StringBuilder m1016super = Cgoto.m1016super("isExpiredRedownload force to false, reason(global setting) id=");
            m1016super.append(getId());
            m1016super.append(" name=");
            m1016super.append(getName());
            com.ss.android.socialbase.downloader.c.a.c(m1016super.toString());
            return false;
        }
    ...
    public ContentValues toContentValues() {
        ...
        contentValues.put(ao.d, Integer.valueOf(this.id));
        ...
        contentValues.put(NotificationCompatJellybean.KEY_TITLE, this.title);
    ...
    public String toString() {
        StringBuilder m1016super = Cgoto.m1016super("DownloadInfo{id=");
        m1016super.append(this.id);
        m1016super.append(", name='");
        Cgoto.m987abstract(m1016super, this.name, '\'', ", title='");
        Cgoto.m987abstract(m1016super, this.title, '\'', ", url='");
        Cgoto.m987abstract(m1016super, this.url, '\'', ", savePath='");
        m1016super.append(this.savePath);
        m1016super.append('\'');
        m1016super.append('}');
