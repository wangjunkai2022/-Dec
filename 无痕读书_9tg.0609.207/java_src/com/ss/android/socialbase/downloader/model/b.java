...
public class b implements Parcelable {
    ...
    public static final String f11984a = b.class.getSimpleName();
    ...
    public ContentValues a() {
        ...
        contentValues.put(ao.d, Integer.valueOf(this.b));
    ...
    public long c(boolean z) {
        ...
        StringBuilder m1016super = Cgoto.m1016super("contentLength:");
        m1016super.append(this.f);
        m1016super.append(" curOffset:");
        m1016super.append(n());
        m1016super.append(" oldOffset:");
        m1016super.append(this.i);
        m1016super.append(" retainLen:");
        m1016super.append(j3);
        com.ss.android.socialbase.downloader.c.a.b("DownloadChunk", m1016super.toString());
        if (j3 < 0) {
            return 0L;
        }
        return j3;
    ...
    public b(Cursor cursor) {
        ...
        this.b = cursor.getInt(cursor.getColumnIndex(ao.d));
    ...
    public List<b> a(int i, long j) {
        ...
        long c = bVar2.c(true);
        long j6 = c / i2;
        com.ss.android.socialbase.downloader.c.a.b(f11984a, "retainLen:" + c + " divideChunkForReuse chunkSize:" + j6 + " current host downloadChunk index:" + bVar2.g);
        int i3 = 0;
        while (i3 < i2) {
            if (i3 == 0) {
                j3 = l();
                ...
                if (i3 == i4) {
                    ...
                    com.ss.android.socialbase.downloader.c.a.b(f11984a, "divide sub chunk : " + i3 + " startOffset:" + j3 + " curOffset:" + m + " endOffset:" + j8 + " contentLen:" + j4);
                    arrayList.add(a2);
                    m += j6;
                    i3++;
                    bVar2 = this;
            ...
            com.ss.android.socialbase.downloader.c.a.b(f11984a, "divide sub chunk : " + i3 + " startOffset:" + j3 + " curOffset:" + m + " endOffset:" + j82 + " contentLen:" + j4);
            arrayList.add(a22);
            m += j6;
            i3++;
            bVar2 = this;
        ...
        com.ss.android.socialbase.downloader.c.a.b(f11984a, "reuseChunkContentLen:" + j9);
