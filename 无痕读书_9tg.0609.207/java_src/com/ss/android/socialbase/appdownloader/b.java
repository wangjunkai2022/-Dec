...
public class b {
    ...
    public static final String f11747a = "b";
    public static c b;
    public static a c;
    ...
    public static class a implements a.InterfaceC0150a {
        ...
        public a(Context context, Intent intent, int i, JSONObject jSONObject, InterfaceC0147b interfaceC0147b) {
            this.c = jSONObject;
            int optInt = jSONObject.optInt("query_interval", 1000);
            this.b = optInt;
            this.f11748a = new e(context, intent, i, interfaceC0147b, optInt);
        }
        ...
        public void b() {
            if (!this.f11748a.i) {
                ...
                obtain.what = 2;
                this.f11748a.f.sendMessage(obtain);
            }
        ...
        public void c() {
            ...
            obtain2.what = 2;
            this.f11748a.f.sendMessageDelayed(obtain2, optInt * 1000);
        }
    }
    ...
    public static class d implements Callable<Boolean> {
        ...
        public d(Handler handler, Context context, InterfaceC0147b interfaceC0147b, long j) {
        ...
        public Boolean call() throws Exception {
            if (this.b != null && this.d > 0 && this.d <= FragmentStateAdapter.GRACE_WINDOW_TIME_MS) {
    ...
    public static class e implements h.a {
        ...
        /* renamed from: a  reason: collision with root package name */
        public static int f11751a;
        public static int b;
        public final Context c;
        public final Intent d;
        public final InterfaceC0147b e;
        public final Handler f;
        public final long g;
        public Future<Boolean> h;
        public boolean i = false;

        public e(Context context, Intent intent, int i, InterfaceC0147b interfaceC0147b, long j) {
            this.c = context;
            this.d = intent;
            b = i;
        ...
        public void a(Message message) {
            if (message != null) {
                ...
                if (i == 1) {
                    long j = this.g;
                    if (j <= 0 || j > FragmentStateAdapter.GRACE_WINDOW_TIME_MS) {
                        return;
                    }
                    f11751a = 1;
            ...
            if (!TextUtils.isEmpty(optString)) {
                ...
                switch (c2) {
                    ...
                    case 5:
                        ...
                        break;
                    case 6:
                        String a5 = com.ss.android.socialbase.appdownloader.f.c.a(a4.c("bh"), a4.c(ak.aB));
    ...
    public static com.ss.android.socialbase.appdownloader.a b(JSONObject jSONObject, com.ss.android.socialbase.downloader.g.a aVar) {
        ...
        aVar2.f11745a = jSONObject.optString("type");
        aVar2.e = "vbi";
    ...
    public static boolean a(File file, DownloadInfo downloadInfo, @NonNull JSONObject jSONObject) {
        ...
        if (!TextUtils.isEmpty(optString) && !TextUtils.isEmpty(optString)) {
            file2 = new File(Cgoto.m991class(Cgoto.m1016super(path), File.separator, optString));
        }
        if (file2 != null) {
            try {
            ...
            if ((System.currentTimeMillis() - sharedPreferences.getLong("last_jump_unknown_source_time", 0L)) / 60000 >= optLong && !a(context)) {
                ...
                if (jSONObject.optInt("show_unknown_source_dialog", 0) == 1) {
                    ...
                    try {
                        ...
                        if (aVar != null) {
                            aVar.b = 1;
                            StringBuilder m1016super = Cgoto.m1016super("tryShowUnknownSourceDialog");
                            m1016super.append(a(th));
                            aVar.c = m1016super.toString();
                        }
                        return false;
                    }
                }
    ...
    public static boolean a(Context context, @Nullable Intent intent, int i, JSONObject jSONObject) {
        try {
            if (com.ss.android.socialbase.appdownloader.f.d.b() && Build.VERSION.SDK_INT < 26 && !d(context)) {
                ...
                if (fVar.a()) {
                    a(context, intent, i, jSONObject, new InterfaceC0147b() { // from class: com.ss.android.socialbase.appdownloader.b.1
                        @Override // com.ss.android.socialbase.appdownloader.b.InterfaceC0147b
                ...
                if (bVar.a()) {
                    a(context, intent, i, jSONObject, new InterfaceC0147b() { // from class: com.ss.android.socialbase.appdownloader.b.2
                        @Override // com.ss.android.socialbase.appdownloader.b.InterfaceC0147b
                        public boolean a(@NonNull Context context2) {
                            return b.e(context2);
                        }
    ...
    public static void a(Context context, Intent intent, int i, JSONObject jSONObject, InterfaceC0147b interfaceC0147b) {
        if (c != null) {
            com.ss.android.socialbase.downloader.a.a.a().b(c);
            c = null;
        }
        c = new a(context, intent, i, jSONObject, interfaceC0147b);
