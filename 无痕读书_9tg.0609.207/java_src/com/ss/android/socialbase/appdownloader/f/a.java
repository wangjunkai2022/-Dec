...
public class a {
    ...
    public static final HashMap<String, g.a> f11773a = new HashMap<>();
    ...
    public static g.a b(String str) {
        if (f11773a.containsKey(str)) {
            g.a aVar = f11773a.get(str);
            if (aVar != null) {
                return aVar;
            }
            return null;
    ...
    public static boolean a(JSONObject jSONObject, Context context, String str) {
        if (!TextUtils.isEmpty(str) && context != null && jSONObject != null) {
            String optString = jSONObject.optString(ak.aB);
            try {
