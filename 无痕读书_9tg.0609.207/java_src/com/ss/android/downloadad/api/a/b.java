...
public class b implements a {
    ...
    public JSONObject ae() {
        ...
        try {
            ...
            jSONObject.put("enable_ah", this.f11563a ? 1 : 0);
            if (!this.b) {
                i = 0;
            }
    ...
    public AdDownloadController ah() {
        return new AdDownloadController.Builder().setIsEnableBackDialog(this.x).setLinkMode(this.n).setDownloadMode(this.o).setEnableShowComplianceDialog(this.T).setEnableAH(this.f11563a).setEnableAM(this.b).build();
    }
    ...
    public b(DownloadModel downloadModel, DownloadEventConfig downloadEventConfig, DownloadController downloadController, int i) {
        ...
        this.f11563a = downloadController.enableAH();
