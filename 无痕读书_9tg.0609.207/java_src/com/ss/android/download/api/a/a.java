...
public class a implements k {
    ...
    public static Dialog a(final com.ss.android.download.api.model.b bVar) {
        ...
        AlertDialog show = new AlertDialog.Builder(bVar.f11557a).setTitle(bVar.b).setMessage(bVar.c).setPositiveButton(bVar.d, new DialogInterface.OnClickListener() { // from class: com.ss.android.download.api.a.a.2
            @Override // android.content.DialogInterface.OnClickListener
            public void onClick(DialogInterface dialogInterface, int i) {
                b.InterfaceC0132b interfaceC0132b = com.ss.android.download.api.model.b.this.h;
