...
public final class RGBLuminanceSource extends LuminanceSource {
    ...
    public LuminanceSource crop(int i, int i2, int i3, int i4) {
        return new RGBLuminanceSource(this.luminances, this.dataWidth, this.dataHeight, this.left + i, this.f11488top + i2, i3, i4);
    }
    ...
    public byte[] getRow(int i, byte[] bArr) {
        if (i >= 0 && i < getHeight()) {
            ...
            System.arraycopy(this.luminances, ((i + this.f11488top) * this.dataWidth) + this.left, bArr, 0, width);
            return bArr;
        }
