...
public final class PlanarYUVLuminanceSource extends LuminanceSource {
    ...
    private void reverseHorizontal(int i, int i2) {
        ...
        int i3 = (this.f11487top * this.dataWidth) + this.left;
        int i4 = 0;
        while (i4 < i2) {
            int i5 = (i / 2) + i3;
            int i6 = (i3 + i) - 1;
    ...
    public LuminanceSource crop(int i, int i2, int i3, int i4) {
        return new PlanarYUVLuminanceSource(this.yuvData, this.dataWidth, this.dataHeight, this.left + i, this.f11487top + i2, i3, i4, false);
    }
    ...
    public byte[] getRow(int i, byte[] bArr) {
        if (i >= 0 && i < getHeight()) {
            ...
            System.arraycopy(this.yuvData, ((i + this.f11487top) * this.dataWidth) + this.left, bArr, 0, width);
            return bArr;
        }
    ...
    public int[] renderThumbnail() {
        ...
        byte[] bArr = this.yuvData;
        int i = (this.f11487top * this.dataWidth) + this.left;
        for (int i2 = 0; i2 < height; i2++) {
            int i3 = i2 * width;
            for (int i4 = 0; i4 < width; i4++) {
                iArr[i3 + i4] = ((bArr[(i4 << 1) + i] & ExifInterface.MARKER) * 65793) | ViewCompat.MEASURED_STATE_MASK;
            }
            i += this.dataWidth << 1;
        }
        return iArr;
