    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        ...
        if (this.collapsingTitleEnabled && (view = this.dummyView) != null) {
            ...
            if (z2) {
                ...
                this.collapsingTextHelper.setCollapsedBounds(this.tmpRect.left + (z3 ? this.toolbar.getTitleMarginEnd() : this.toolbar.getTitleMarginStart()), this.toolbar.getTitleMarginTop() + this.tmpRect.top + maxOffsetForPinChild, this.tmpRect.right - (z3 ? this.toolbar.getTitleMarginStart() : this.toolbar.getTitleMarginEnd()), (this.tmpRect.bottom + maxOffsetForPinChild) - this.toolbar.getTitleMarginBottom());
