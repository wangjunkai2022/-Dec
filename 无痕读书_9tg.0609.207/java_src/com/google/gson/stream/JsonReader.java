...
public class JsonReader implements Closeable {
        ...
        JsonReaderInternalAccess.INSTANCE = new JsonReaderInternalAccess() { // from class: com.google.gson.stream.JsonReader.1
            ...
            public void promoteNameToValue(JsonReader jsonReader) throws IOException {
                ...
                if (i == 13) {
                    ...
                    StringBuilder m1016super = Cgoto.m1016super("Expected a name but was ");
                    m1016super.append(jsonReader.peek());
                    m1016super.append(jsonReader.locationString());
    ...
    private int nextNonWhitespace(boolean z) throws IOException {
        ...
        while (true) {
            if (i == i2) {
                ...
                if (!fillBuffer(1)) {
                    if (z) {
                        StringBuilder m1016super = Cgoto.m1016super("End of input");
                        m1016super.append(locationString());
                                    ...
                                    while (i5 < i6) {
                                        ...
                                        if (c3 < '0' || c3 > '9') {
                                            if (c3 >= 'a' && c3 <= 'f') {
                                                ...
                                                StringBuilder m1016super = Cgoto.m1016super("\\u");
                                                m1016super.append(new String(this.buffer, this.pos, 4));
    ...
    */
    ...
    private IOException syntaxError(String str) throws IOException {
        ...
        m1016super.append(locationString());
        throw new MalformedJsonException(m1016super.toString());
    }
    ...
    public void beginArray() throws IOException {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Expected BEGIN_ARRAY but was ");
        m1016super.append(peek());
        m1016super.append(locationString());
        throw new IllegalStateException(m1016super.toString());
    }
    ...
    public void beginObject() throws IOException {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Expected BEGIN_OBJECT but was ");
        m1016super.append(peek());
        m1016super.append(locationString());
        throw new IllegalStateException(m1016super.toString());
    }
    ...
    public void endArray() throws IOException {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Expected END_ARRAY but was ");
        m1016super.append(peek());
        m1016super.append(locationString());
        throw new IllegalStateException(m1016super.toString());
    }
    ...
    public void endObject() throws IOException {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Expected END_OBJECT but was ");
        m1016super.append(peek());
        m1016super.append(locationString());
        throw new IllegalStateException(m1016super.toString());
    }
    ...
    public boolean nextBoolean() throws IOException {
        ...
        if (i == 5) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Expected a boolean but was ");
            m1016super.append(peek());
            m1016super.append(locationString());
            throw new IllegalStateException(m1016super.toString());
        }
    ...
    public double nextDouble() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Expected a double but was ");
            m1016super.append(peek());
            m1016super.append(locationString());
            throw new IllegalStateException(m1016super.toString());
        }
    ...
    public int nextInt() throws IOException {
        ...
        if (i == 15) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Expected an int but was ");
            m1016super.append(this.peekedLong);
            m1016super.append(locationString());
            throw new NumberFormatException(m1016super.toString());
        }
        if (i == 16) {
            ...
            StringBuilder m1016super2 = Cgoto.m1016super("Expected an int but was ");
            m1016super2.append(peek());
            m1016super2.append(locationString());
        ...
        StringBuilder m1016super3 = Cgoto.m1016super("Expected an int but was ");
        m1016super3.append(this.peekedString);
        m1016super3.append(locationString());
        throw new NumberFormatException(m1016super3.toString());
    }
    ...
    public long nextLong() throws IOException {
        ...
        if (i == 16) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Expected a long but was ");
            m1016super.append(peek());
            m1016super.append(locationString());
            throw new IllegalStateException(m1016super.toString());
        } else {
        ...
        StringBuilder m1016super2 = Cgoto.m1016super("Expected a long but was ");
        m1016super2.append(this.peekedString);
        m1016super2.append(locationString());
    ...
    public void nextNull() throws IOException {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Expected null but was ");
        m1016super.append(peek());
        m1016super.append(locationString());
        throw new IllegalStateException(m1016super.toString());
    }
    ...
    public String nextString() throws IOException {
        ...
        if (i == 10) {
            ...
            StringBuilder m1016super = Cgoto.m1016super("Expected a string but was ");
            m1016super.append(peek());
            m1016super.append(locationString());
            throw new IllegalStateException(m1016super.toString());
        }
