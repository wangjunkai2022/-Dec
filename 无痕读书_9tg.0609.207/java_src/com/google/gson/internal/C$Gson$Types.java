    ...
    public static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder m1016super = Cgoto.m1016super("? super ");
                m1016super.append(C$Gson$Types.typeToString(this.lowerBound));
                return m1016super.toString();
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                StringBuilder m1016super2 = Cgoto.m1016super("? extends ");
                m1016super2.append(C$Gson$Types.typeToString(this.upperBound));
