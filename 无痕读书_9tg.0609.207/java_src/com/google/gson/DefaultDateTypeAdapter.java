...
public final class DefaultDateTypeAdapter extends TypeAdapter<Date> {
    ...
    public String toString() {
        ...
        if (dateFormat instanceof SimpleDateFormat) {
            StringBuilder m1016super = Cgoto.m1016super("DefaultDateTypeAdapter(");
            m1016super.append(((SimpleDateFormat) dateFormat).toPattern());
            m1016super.append(')');
            return m1016super.toString();
        }
        StringBuilder m1016super2 = Cgoto.m1016super("DefaultDateTypeAdapter(");
        m1016super2.append(dateFormat.getClass().getSimpleName());
        m1016super2.append(')');
