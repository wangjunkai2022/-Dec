...
public class UMLogCommon {
    ...
    public static final String SC_10001 = Cgoto.m1001goto("67292", Cgoto.m1016super("不能在非主进程进行初始化|目前只能在主进程进行初始化，如何正确初始化请详见地址："));
    public static final String SC_10002 = Cgoto.m1001goto("67292", Cgoto.m1016super("不能在非Application的onCreate方法中进行初始化|目前只能在Application的onCreate方法中进行初始化，如何正确初始化请详见地址："));
    public static final String SC_10007 = Cgoto.m1001goto("67292", Cgoto.m1016super("AppKey不能为空|您必须正确设置AppKey，如何正确初始化请详见地址："));
}
