...
public class d {
    ...
    public static final String f12183a = "appkey";
    ...
    public static final String[] aH = {as, at, "_$!du", "_$!c", Y, "_$!sp", "event_name", "token", "time", "ip", ak.O, "region", "city", "browser", ak.x, ak.F, "device_version", ak.ai, "screen_width", "screen_height", "referrer", "referrer_domain", "initial_referrer", "initial_referrer_domain", "initial_view_time", "search_engine", "keyword", "ali_lib", "utm_source", "utm_medium", "utm_term", "utm_content", "utm_campaign", "date", "hour", TypeAdapters.AnonymousClass27.MINUTE, "app_version", "sp"};
}
