...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, CursorFilter.CursorFilterClient {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        if (this.mDataValid) {
            ...
            throw new IllegalStateException(Cgoto.m1003implements("couldn't move cursor to position ", i));
        }
    ...
    public Cursor swapCursor(Cursor cursor) {
        ...
        if (cursor != null) {
            ...
            this.mRowIDColumn = cursor.getColumnIndexOrThrow(ao.d);
    ...
    public void init(Context context, Cursor cursor, int i) {
        ...
        this.mRowIDColumn = z ? cursor.getColumnIndexOrThrow(ao.d) : -1;
        if ((i & 2) == 2) {
