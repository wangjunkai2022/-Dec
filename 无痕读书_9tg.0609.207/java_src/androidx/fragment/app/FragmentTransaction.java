...
public abstract class FragmentTransaction {
            ...
            if (transitionName != null) {
                if (this.mSharedElementSourceNames == null) {
                    ...
                    if (this.mSharedElementSourceNames.contains(transitionName)) {
                        throw new IllegalArgumentException(Cgoto.m996else("A shared element with the source name '", transitionName, "' has already been added to the transaction."));
                    }
                } else {
                    throw new IllegalArgumentException(Cgoto.m996else("A shared element with the target name '", str, "' has already been added to the transaction."));
                }
    ...
    public void doAddOp(int i, Fragment fragment, @Nullable String str, int i2) {
        ...
        if (!cls.isAnonymousClass() && Modifier.isPublic(modifiers) && (!cls.isMemberClass() || Modifier.isStatic(modifiers))) {
            if (str != null) {
                ...
                if (str2 != null && !str.equals(str2)) {
                    ...
                    sb.append(fragment);
                    sb.append(": was ");
                    throw new IllegalStateException(Cgoto.m998final(sb, fragment.mTag, " now ", str));
                }
                fragment.mTag = str;
            }
            if (i != 0) {
        ...
        StringBuilder m1016super = Cgoto.m1016super("Fragment ");
        m1016super.append(cls.getCanonicalName());
        m1016super.append(" must be a public static class to be  properly recreated from instance state.");
