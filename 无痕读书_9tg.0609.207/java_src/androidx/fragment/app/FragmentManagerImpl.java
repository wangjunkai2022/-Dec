...
public final class FragmentManagerImpl extends FragmentManager implements LayoutInflater.Factory2 {
    ...
    public void addFragment(Fragment fragment, boolean z) {
        if (DEBUG) {
            Cgoto.m1017switch("add: ", fragment);
        }
        makeActive(fragment);
    ...
    public void addRetainedFragment(@NonNull Fragment fragment) {
        if (!isStateSaved() && this.mNonConfig.addRetainedFragment(fragment) && DEBUG) {
            Cgoto.m1017switch("Updating retained Fragments: Added ", fragment);
        }
    }
    ...
    public void attachFragment(Fragment fragment) {
        if (DEBUG) {
            Cgoto.m1017switch("attach: ", fragment);
        }
        if (fragment.mDetached) {
            ...
            if (!this.mAdded.contains(fragment)) {
                if (DEBUG) {
                    Cgoto.m1017switch("add from attach: ", fragment);
                }
                synchronized (this.mAdded) {
                    this.mAdded.add(fragment);
                }
    ...
    public void detachFragment(Fragment fragment) {
        if (DEBUG) {
            Cgoto.m1017switch("detach: ", fragment);
        }
        if (fragment.mDetached) {
            return;
        }
        ...
        if (fragment.mAdded) {
            if (DEBUG) {
                Cgoto.m1017switch("remove from detach: ", fragment);
            }
            synchronized (this.mAdded) {
    ...
    public void dump(@NonNull String str, @Nullable FileDescriptor fileDescriptor, @NonNull PrintWriter printWriter, @Nullable String[] strArr) {
        ...
        int size3;
        int size4;
        String m989case = Cgoto.m989case(str, "    ");
        if (!this.mActive.isEmpty()) {
            ...
            for (Fragment fragment : this.mActive.values()) {
                ...
                if (fragment != null) {
                    fragment.dump(m989case, fileDescriptor, printWriter, strArr);
                }
            }
        }
        ...
        if (arrayList2 != null && (size3 = arrayList2.size()) > 0) {
            ...
            for (int i3 = 0; i3 < size3; i3++) {
                ...
                backStackRecord.dump(m989case, printWriter);
            }
        }
        synchronized (this) {
    ...
    */
    ...
    public void hideFragment(Fragment fragment) {
        if (DEBUG) {
            Cgoto.m1017switch("hide: ", fragment);
        }
        if (fragment.mHidden) {
            return;
        }
    ...
    public void makeActive(Fragment fragment) {
        ...
        if (DEBUG) {
            Cgoto.m1017switch("Added fragment to active set ", fragment);
        }
    }
    ...
    public void makeInactive(Fragment fragment) {
        ...
        if (DEBUG) {
            Cgoto.m1017switch("Removed fragment from active set ", fragment);
        }
        for (Fragment fragment2 : this.mActive.values()) {
    ...
    */
    ...
    public View onCreateView(@Nullable View view, @NonNull String str, @NonNull Context context, @NonNull AttributeSet attributeSet) {
        if ("fragment".equals(str)) {
            ...
            if (DEBUG) {
                StringBuilder m1016super = Cgoto.m1016super("onCreateView: id=0x");
                m1016super.append(Integer.toHexString(resourceId));
                m1016super.append(" fname=");
                m1016super.append(str2);
                m1016super.append(" existing=");
                m1016super.append(findFragmentById);
                m1016super.toString();
            }
            ...
            throw new IllegalStateException(Cgoto.m996else("Fragment ", str2, " did not create a view."));
        }
        return null;
    }
    ...
    public void putFragment(Bundle bundle, String str, Fragment fragment) {
        if (fragment.mFragmentManager != this) {
            throwException(new IllegalStateException(Cgoto.m1023try("Fragment ", fragment, " is not currently in the FragmentManager")));
        }
    ...
    public void removeRetainedFragment(@NonNull Fragment fragment) {
        if (!isStateSaved() && this.mNonConfig.removeRetainedFragment(fragment) && DEBUG) {
            Cgoto.m1017switch("Updating retained Fragments: Removed ", fragment);
        }
    }
    ...
    public void restoreSaveState(Parcelable parcelable) {
        ...
        for (Fragment fragment : this.mNonConfig.getRetainedFragments()) {
            if (DEBUG) {
                Cgoto.m1017switch("restoreSaveState: re-attaching retained ", fragment);
            }
        ...
        while (it2.hasNext()) {
            ...
            if (next != null) {
                ...
                if (DEBUG) {
                    StringBuilder m1016super = Cgoto.m1016super("restoreSaveState: active (");
                    m1016super.append(instantiate.mWho);
                    m1016super.append("): ");
                    m1016super.append(instantiate);
                    m1016super.toString();
                }
        ...
        if (arrayList != null) {
            ...
            while (it3.hasNext()) {
                ...
                if (fragment3 == null) {
                    throwException(new IllegalStateException(Cgoto.m996else("No instantiated fragment for (", next2, ")")));
                }
        ...
        if (fragmentManagerState.mBackStack != null) {
            ...
            while (true) {
                ...
                if (DEBUG) {
                    StringBuilder m1020throw = Cgoto.m1020throw("restoreAllState: back stack #", i, " (index ");
                    m1020throw.append(instantiate2.mIndex);
                    m1020throw.append("): ");
                    m1020throw.append(instantiate2);
                    m1020throw.toString();
                    PrintWriter printWriter = new PrintWriter(new LogWriter("FragmentManager"));
    ...
    public Parcelable saveAllState() {
        ...
        for (Fragment fragment : this.mActive.values()) {
            if (fragment != null) {
                if (fragment.mFragmentManager != this) {
                    throwException(new IllegalStateException(Cgoto.m1023try("Failure saving state: active ", fragment, " was removed from the FragmentManager")));
                }
        ...
        if (z) {
            ...
            if (size2 > 0) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next.mFragmentManager != this) {
                        throwException(new IllegalStateException(Cgoto.m1023try("Failure saving state: active ", next, " was removed from the FragmentManager")));
                    }
                    if (DEBUG) {
                        StringBuilder m1016super = Cgoto.m1016super("saveAllState: adding fragment (");
                        m1016super.append(next.mWho);
                        m1016super.append("): ");
                        m1016super.append(next);
                        m1016super.toString();
                    }
                }
            } else {
            ...
            if (arrayList3 != null && (size = arrayList3.size()) > 0) {
                ...
                for (int i2 = 0; i2 < size; i2++) {
                    ...
                    if (DEBUG) {
                        StringBuilder m1020throw = Cgoto.m1020throw("saveAllState: adding back stack #", i2, ": ");
                        m1020throw.append(this.mBackStack.get(i2));
                        m1020throw.toString();
                    }
                }
            }
    ...
    public void showFragment(Fragment fragment) {
        if (DEBUG) {
            Cgoto.m1017switch("show: ", fragment);
        }
        if (fragment.mHidden) {
    ...
    public void popBackStack(int i, int i2) {
        ...
        throw new IllegalArgumentException(Cgoto.m1003implements("Bad id: ", i));
    }
