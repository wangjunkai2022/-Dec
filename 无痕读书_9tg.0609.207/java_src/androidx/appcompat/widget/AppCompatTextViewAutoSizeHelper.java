        ...
        if (supportsAutoSizeText()) {
            ...
            if (length > 0) {
                ...
                if (!setupAutoSizeUniformPresetSizesConfiguration()) {
                    StringBuilder m1016super = Cgoto.m1016super("None of the preset sizes is valid: ");
                    m1016super.append(Arrays.toString(iArr));
    ...
    public void setAutoSizeTextTypeWithDefaults(int i) {
        if (supportsAutoSizeText()) {
            if (i == 0) {
                ...
                throw new IllegalArgumentException(Cgoto.m1003implements("Unknown auto-size text type: ", i));
            }
        }
    }
