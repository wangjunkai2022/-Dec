...
public class ActivityChooserModel extends DataSetObservable {
    ...
    public static final class ActivityResolveInfo implements Comparable<ActivityResolveInfo> {
        ...
        public String toString() {
            StringBuilder m1025while = Cgoto.m1025while("[", "resolveInfo:");
            m1025while.append(this.resolveInfo.toString());
            m1025while.append("; weight:");
            m1025while.append(new BigDecimal(this.weight));
            m1025while.append("]");
    ...
    public static final class HistoricalRecord {
        ...
        public String toString() {
            StringBuilder m1025while = Cgoto.m1025while("[", "; activity:");
            m1025while.append(this.activity);
            m1025while.append("; time:");
            m1025while.append(this.time);
            m1025while.append("; weight:");
            m1025while.append(new BigDecimal(this.weight));
            m1025while.append("]");
            return m1025while.toString();
    ...
    public ActivityChooserModel(Context context, String str) {
        ...
        if (!TextUtils.isEmpty(str) && !str.endsWith(HISTORY_FILE_EXTENSION)) {
            this.mHistoryFileName = Cgoto.m989case(str, HISTORY_FILE_EXTENSION);
        } else {
