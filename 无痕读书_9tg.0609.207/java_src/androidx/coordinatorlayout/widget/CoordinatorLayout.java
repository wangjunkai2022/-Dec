...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2, NestedScrollingParent3 {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior != null && behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                if (!acquireTempRect2.contains(acquireTempRect)) {
                    StringBuilder m1016super = Cgoto.m1016super("Rect should be within the child's bounds. Rect:");
                    m1016super.append(acquireTempRect.toShortString());
                    m1016super.append(" | Bounds:");
                    m1016super.append(acquireTempRect2.toShortString());
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(Cgoto.m989case("Could not inflate Behavior subclass ", str), e);
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (findViewById == null) {
                ...
                StringBuilder m1016super = Cgoto.m1016super("Could not find CoordinatorLayout descendant view with id ");
                m1016super.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
                m1016super.append(" to anchor view ");
                m1016super.append(view);
