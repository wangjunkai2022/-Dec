...
public abstract class VersionedParcel {
    ...
    public Serializable readSerializable() {
        ...
        try {
            ...
            throw new RuntimeException(Cgoto.m996else("VersionedParcelable encountered IOException reading a Serializable object (name = ", readString, ")"), e);
        } catch (ClassNotFoundException e2) {
            throw new RuntimeException(Cgoto.m996else("VersionedParcelable encountered ClassNotFoundException reading a Serializable object (name = ", readString, ")"), e2);
        }
    }
    ...
    private void writeSerializable(Serializable serializable) {
        ...
        try {
            ...
            throw new RuntimeException(Cgoto.m996else("VersionedParcelable encountered IOException writing serializable object (name = ", name, ")"), e);
        }
    }
