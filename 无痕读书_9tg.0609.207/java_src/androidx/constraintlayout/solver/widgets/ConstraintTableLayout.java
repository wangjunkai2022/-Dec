...
public class ConstraintTableLayout extends ConstraintWidgetContainer {
    ...
    public class HorizontalSlice {
        ...
        public ConstraintWidget f10607top;
    ...
    private void setChildrenConnections() {
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            ConstraintWidget constraintWidget4 = horizontalSlice.f10607top;
    ...
    private void setHorizontalSlices() {
        ...
        for (int i = 0; i < this.mNumRows; i++) {
            ...
            horizontalSlice.f10607top = constraintWidget;
    ...
    public String getColumnsAlignmentRepresentation() {
        ...
        for (int i = 0; i < size; i++) {
            int i2 = this.mVerticalSlices.get(i).alignment;
            if (i2 == 1) {
                str = Cgoto.m989case(str, "L");
            } else if (i2 == 0) {
                str = Cgoto.m989case(str, "C");
            } else if (i2 == 3) {
                str = Cgoto.m989case(str, "F");
            } else if (i2 == 2) {
                str = Cgoto.m989case(str, "R");
            }
        }
        return str;
    }
