...
public class ConstraintLayout extends ViewGroup {
    ...
    /* JADX WARN: Removed duplicated region for block: B:161:0x02d4 A[ADDED_TO_REGION] */
    /*
                    ...
                    if (i17 != -1) {
                        ...
                        if (i11 != -1) {
                            ...
                            if (targetWidget6 != null) {
                                ...
                                i = i16;
                                i2 = i14;
                                viewWidget2.immediateConnect(type, targetWidget6, type, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i15);
                            } else {
                                f = f3;
                                i = i16;
                                i2 = i14;
                            ...
                            if (i12 != -1 && (targetWidget = getTargetWidget(i12)) != null) {
                                viewWidget2.immediateConnect(ConstraintAnchor.Type.LEFT, targetWidget, ConstraintAnchor.Type.RIGHT, ((ViewGroup.MarginLayoutParams) layoutParams).leftMargin, i15);
                            }
                        }
                        if (i13 != -1) {
                            ...
                            int i18 = i2;
                            if (i18 != -1 && (targetWidget2 = getTargetWidget(i18)) != null) {
