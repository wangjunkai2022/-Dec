...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z4) {
                ...
                ViewCompat.postOnAnimationDelayed(arrayList3.get(0).itemView, runnable3, Math.max(z2 ? getMoveDuration() : 0L, z3 ? getChangeDuration() : 0L) + (z ? getRemoveDuration() : 0L));
            }
        }
    }
    ...
    public static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder m1016super = Cgoto.m1016super("ChangeInfo{oldHolder=");
            m1016super.append(this.oldHolder);
            m1016super.append(", newHolder=");
            m1016super.append(this.newHolder);
            m1016super.append(", fromX=");
            m1016super.append(this.fromX);
            m1016super.append(", fromY=");
            m1016super.append(this.fromY);
            m1016super.append(", toX=");
            m1016super.append(this.toX);
            m1016super.append(", toY=");
            m1016super.append(this.toY);
            m1016super.append('}');
