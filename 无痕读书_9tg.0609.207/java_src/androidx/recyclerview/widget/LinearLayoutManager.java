...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    public void setOrientation(int i) {
        if (i != 0 && i != 1) {
            throw new IllegalArgumentException(Cgoto.m1003implements("invalid orientation:", i));
        }
    ...
    public void validateChildOrder() {
        ...
        if (this.mShouldReverseLayout) {
            for (int i = 1; i < getChildCount(); i++) {
                ...
                if (position2 < position) {
                    logChildren();
                    StringBuilder m1016super = Cgoto.m1016super("detected invalid position. loc invalid? ");
                    m1016super.append(decoratedStart2 < decoratedStart);
        ...
        for (int i2 = 1; i2 < getChildCount(); i2++) {
            ...
            if (position3 < position) {
                logChildren();
                StringBuilder m1016super2 = Cgoto.m1016super("detected invalid position. loc invalid? ");
                m1016super2.append(decoratedStart3 < decoratedStart);
