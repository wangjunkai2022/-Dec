...
public class DiffUtil {
    ...
    public static class DiffResult {
        ...
        public int convertNewPositionToOld(@IntRange(from = 0) int i) {
            ...
            StringBuilder m1020throw = Cgoto.m1020throw("Index out of bounds - passed position = ", i, ", new list size = ");
            m1020throw.append(this.mNewListSize);
            throw new IndexOutOfBoundsException(m1020throw.toString());
        }
        ...
        public int convertOldPositionToNew(@IntRange(from = 0) int i) {
            ...
            StringBuilder m1020throw = Cgoto.m1020throw("Index out of bounds - passed position = ", i, ", old list size = ");
            m1020throw.append(this.mOldListSize);
            throw new IndexOutOfBoundsException(m1020throw.toString());
        }
    ...
    public static Snake midPoint(Range range, Callback callback, CenteredArray centeredArray, CenteredArray centeredArray2) {
        if (range.oldSize() >= 1 && range.newSize() >= 1) {
            int newSize = ((range.newSize() + range.oldSize()) + 1) / 2;
