...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent3, NestedScrollingChild3, ScrollingView {
    ...
    public static class SavedState extends View.BaseSavedState {
        ...
        public String toString() {
            StringBuilder m1016super = Cgoto.m1016super("HorizontalScrollView.SavedState{");
            m1016super.append(Integer.toHexString(System.identityHashCode(this)));
            m1016super.append(" scrollPosition=");
            return Cgoto.m1019this(m1016super, this.scrollPosition, "}");
        }
