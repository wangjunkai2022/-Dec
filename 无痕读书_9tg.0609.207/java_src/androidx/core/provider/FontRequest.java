...
public final class FontRequest {
    ...
    public String toString() {
        ...
        StringBuilder m1016super = Cgoto.m1016super("FontRequest {mProviderAuthority: ");
        m1016super.append(this.mProviderAuthority);
        m1016super.append(", mProviderPackage: ");
        m1016super.append(this.mProviderPackage);
        m1016super.append(", mQuery: ");
        m1016super.append(this.mQuery);
        m1016super.append(", mCertificates:");
