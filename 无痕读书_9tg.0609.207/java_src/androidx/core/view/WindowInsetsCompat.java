...
public class WindowInsetsCompat {
    ...
    public static Insets insetInsets(Insets insets, int i, int i2, int i3, int i4) {
        ...
        int max2 = Math.max(0, insets.f10610top - i2);
    ...
    public int getStableInsetTop() {
        return getStableInsets().f10610top;
    }
    ...
    public int getSystemWindowInsetTop() {
        return getSystemWindowInsets().f10610top;
    }
    ...
    public WindowInsetsCompat inset(@NonNull Insets insets) {
        return inset(insets.left, insets.f10610top, insets.right, insets.bottom);
    }
    ...
    public static class BuilderImpl20 extends BuilderImpl {
        ...
        public void setSystemWindowInsets(@NonNull Insets insets) {
            ...
            if (windowInsets != null) {
                this.mInsets = windowInsets.replaceSystemWindowInsets(insets.left, insets.f10610top, insets.right, insets.bottom);
            }
        }
