    ...
    public void placeFragmentInViewHolder(@NonNull final FragmentViewHolder fragmentViewHolder) {
        ...
        if (fragment != null) {
            ...
            if (fragment.isAdded() && view == null) {
                ...
                StringBuilder m1016super = Cgoto.m1016super("f");
                m1016super.append(fragmentViewHolder.getItemId());
                beginTransaction.add(fragment, m1016super.toString()).setMaxLifecycle(fragment, Lifecycle.State.STARTED).commitNow();
        ...
        if (this.mSavedStates.isEmpty() && this.mFragments.isEmpty()) {
            ...
            for (String str : bundle.keySet()) {
                if (isValidKey(str, KEY_PREFIX_FRAGMENT)) {
                    ...
                    throw new IllegalArgumentException(Cgoto.m989case("Unexpected key in savedState: ", str));
                }
            }
