...
STRINGS.CONFIRM_DELETE_BOOK = '是否删除小说？';
...
STRINGS.UNSUPPORTED_FILE_TYPE = '不支持的文件类型，请选择TXT小说文件。';
...
STRINGS.SUPPORTED_FILE_TYPES = '目前暂只支持TXT类型';
...
STRINGS.SELECT_BUTTON_LABLE2 = "可一次性选择多个文件";
STRINGS.WIFI_AVAILABLE = "WiFi连接已启用";
STRINGS.FILE_MAX_SIZE = "文件大小超限制(80M)";
