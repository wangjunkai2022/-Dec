.class public Lcom/apk/k30;
.super Lcom/apk/n0;
.source "ComicReadLockHelper.java"


# static fields
.field public static continue:Lcom/apk/k30;


# instance fields
.field public abstract:Z

.field public finally:Lcom/manhua/data/bean/ComicReadLockBean;
...
.method public static break(ZZJ)Z
    ...
    const-string p1, "SP_EXTRA_CHAPS_TODAY_COMIC_KEY"
    ...
    const-string p0, "SP_EXTRA_CHAPS_HOUR_COMIC_KEY"
...
.method public static catch()Lcom/apk/k30;
    .locals 2

    .line 1
    sget-object v0, Lcom/apk/k30;->continue:Lcom/apk/k30;

    if-nez v0, :cond_1

    .line 2
    const-class v0, Lcom/apk/k30;

    monitor-enter v0

    .line 3
    :try_start_0
    sget-object v1, Lcom/apk/k30;->continue:Lcom/apk/k30;

    if-nez v1, :cond_0

    .line 4
    new-instance v1, Lcom/apk/k30;

    invoke-direct {v1}, Lcom/apk/k30;-><init>()V
...
.method public static final(Ljava/lang/String;)Z
    ...
    const-string v1, "SP_COMIC_CHAPTER_NEED_VIDEO_AD_KEY"
...
.method public static import(JJLjava/lang/String;)V
    ...
    .line 5
    :cond_2
    const-class p0, Lcom/manhua/data/bean/ComicReadLockBean;
...
.method public class()Ljava/lang/String;
    ...
    .line 1
    iget-boolean v0, p0, Lcom/apk/k30;->private:Z
...
.method public const(Ljava/lang/String;Ljava/lang/String;Lcom/apk/k1;)V
    ...
    .line 2
    iput-object p3, p0, Lcom/apk/k30;->package:Lcom/apk/k1;
    ...
    .line 4
    iget-object v1, v0, Lcom/apk/finally;->else:Lorg/json/JSONObject;
    ...
    .line 5
    iget-object v0, v0, Lcom/apk/finally;->else:Lorg/json/JSONObject;
    ...
    .line 9
    const-class v0, Lcom/manhua/data/bean/ComicReadLockBean;

    invoke-static {v0}, Lorg/litepal/LitePal;->findFirst(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lcom/manhua/data/bean/ComicReadLockBean;

    iput-object v0, p0, Lcom/apk/k30;->finally:Lcom/manhua/data/bean/ComicReadLockBean;

    if-nez v0, :cond_2

    .line 10
    new-instance v0, Lcom/manhua/data/bean/ComicReadLockBean;

    invoke-direct {v0}, Lcom/manhua/data/bean/ComicReadLockBean;-><init>()V
    ...
    .line 13
    invoke-virtual {v0, v4, v5}, Lcom/manhua/data/bean/ComicReadLockBean;->setInterval(J)V

    .line 14
    iget-object v0, p0, Lcom/apk/k30;->finally:Lcom/manhua/data/bean/ComicReadLockBean;

    invoke-virtual {v0, v2}, Lcom/manhua/data/bean/ComicReadLockBean;->setInInterval(Z)V
    ...
    invoke-virtual {v0, v4, v5}, Lcom/manhua/data/bean/ComicReadLockBean;->setReadUseTime(J)V
    ...
    invoke-virtual {v0, v4, v5}, Lcom/manhua/data/bean/ComicReadLockBean;->setStartTime(J)V
    ...
    .line 19
    :cond_2
    invoke-virtual {v0}, Lcom/manhua/data/bean/ComicReadLockBean;->getStartTime()J
    ...
    invoke-virtual {v0}, Lcom/manhua/data/bean/ComicReadLockBean;->getReadUseTime()J
    ...
    invoke-virtual {v0}, Lcom/manhua/data/bean/ComicReadLockBean;->getReadChapterIds()Ljava/lang/String;
    ...
    invoke-virtual {v0}, Lcom/manhua/data/bean/ComicReadLockBean;->isInInterval()Z
    ...
    .line 36
    :cond_7
    iput-boolean v3, p0, Lcom/apk/k30;->private:Z

    if-eqz v3, :cond_8

    .line 37
    invoke-static {p1}, Lcom/apk/k30;->final(Ljava/lang/String;)Z
    ...
    .line 40
    :cond_8
    iget-boolean p1, p0, Lcom/apk/k30;->private:Z
    ...
    invoke-static {p1, p2, v0, v1}, Lcom/apk/k30;->break(ZZJ)Z
    ...
    .line 43
    invoke-virtual {p0}, Lcom/apk/k30;->this()Z
    ...
    .line 54
    new-instance v4, Lcom/apk/k30$do;

    invoke-direct {v4, p0, p3}, Lcom/apk/k30$do;-><init>(Lcom/apk/k30;Lcom/apk/k1;)V
...
.method public synthetic super()V
    ...
    invoke-static {v1, v2, v1, v2, v0}, Lcom/apk/k30;->import(JJLjava/lang/String;)V
...
.method public final this()Z
    ...
    :cond_0
    const-string v0, "SP_COMIC_REWARD_CHAPTER_ID_KEY"
...
.method public throw(Ljava/lang/String;Z)V
    ...
    const-string p2, "SP_COMIC_CHAPTER_NEED_VIDEO_AD_KEY"
    ...
    const-string v2, "SP_VIEWTOPREWARD_COMIC_CHAPTERS_KEY"
    ...
    const-string p1, "SP_EXTRA_CHAPS_HOUR_COMIC_KEY"
    ...
    .line 12
    iget-object p1, p0, Lcom/apk/k30;->finally:Lcom/manhua/data/bean/ComicReadLockBean;

    invoke-virtual {p1, v1}, Lcom/manhua/data/bean/ComicReadLockBean;->setInInterval(Z)V
    ...
    const-string v0, "SP_READ_TIME_SAVE_KEY_COMIC"
    ...
    new-instance v0, Lcom/apk/k30$if;

    invoke-direct {v0, p0}, Lcom/apk/k30$if;-><init>(Lcom/apk/k30;)V
    ...
    :cond_4
    const-string p1, "SP_COMIC_REWARD_CHAPTER_ID_KEY"
...
.method public final while(Lcom/apk/k1;Z)V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/apk/k30;->abstract:Z
    ...
    const-string v3, "SP_READ_TIME_SAVE_KEY_COMIC"
    ...
    .line 24
    invoke-static {v0, v1, p1, p2, v2}, Lcom/apk/k30;->import(JJLjava/lang/String;)V
