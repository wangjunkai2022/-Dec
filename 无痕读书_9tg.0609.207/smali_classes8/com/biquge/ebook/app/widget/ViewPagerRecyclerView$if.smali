.class public Lcom/biquge/ebook/app/widget/ViewPagerRecyclerView$if;
...
# direct methods
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;Lcom/apk/dh;)V
    .locals 0

    const p3, 0x7f0c0112

    .line 1
    invoke-direct {p0, p3, p2}, Lcom/chad/library/adapter/base/BaseQuickAdapter;-><init>(ILjava/util/List;)V

    .line 2
    iput-object p1, p0, Lcom/biquge/ebook/app/widget/ViewPagerRecyclerView$if;->do:Landroid/content/Context;

    .line 3
    new-instance p1, Lcom/apk/eh;

    invoke-direct {p1, p0}, Lcom/apk/eh;-><init>(Lcom/biquge/ebook/app/widget/ViewPagerRecyclerView$if;)V
...
.method public convert(Lcom/chad/library/adapter/base/BaseViewHolder;Ljava/lang/Object;)V
    ...
    .line 3
    invoke-virtual {p2}, Lcom/biquge/ebook/app/bean/Book;->isNovel()Z
