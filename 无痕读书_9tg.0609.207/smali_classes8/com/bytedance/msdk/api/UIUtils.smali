.class public Lcom/bytedance/msdk/api/UIUtils;
...
.method public static getHeight(Landroid/app/Activity;)F
    ...
    .line 1
    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->hideBottomUIMenu(Landroid/app/Activity;)V

    .line 2
    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->getRealHeight(Landroid/content/Context;)I

    move-result v0

    .line 3
    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->hasNotchScreen(Landroid/app/Activity;)Z
    ...
    .line 4
    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->getStatusBarHeight(Landroid/content/Context;)F

    move-result v1

    sub-float/2addr v0, v1

    invoke-static {p0, v0}, Lcom/bytedance/msdk/api/UIUtils;->px2dip(Landroid/content/Context;F)I
...
.method public static getInt(Ljava/lang/String;Landroid/app/Activity;)I
    ...
    .line 1
    invoke-static {}, Lcom/bytedance/msdk/api/UIUtils;->isMiui()Z
...
.method public static hasNotchScreen(Landroid/app/Activity;)Z
    ...
    .line 1
    invoke-static {v0, p0}, Lcom/bytedance/msdk/api/UIUtils;->getInt(Ljava/lang/String;Landroid/app/Activity;)I
    ...
    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->hasNotchAtHuawei(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->hasNotchAtOPPO(Landroid/content/Context;)Z
    ...
    .line 2
    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->hasNotchAtVivo(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    invoke-static {p0}, Lcom/bytedance/msdk/api/UIUtils;->isAndroidPHasNotch(Landroid/app/Activity;)Z
