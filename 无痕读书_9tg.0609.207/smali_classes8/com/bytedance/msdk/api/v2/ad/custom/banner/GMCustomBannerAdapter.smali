.class public abstract Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;
.super Lcom/bytedance/msdk/api/v2/ad/custom/base/GMCustomBaseAdapter;
.source "GMCustomBannerAdapter.java"

# interfaces
.implements Lcom/bytedance/msdk/api/v2/ad/custom/banner/IGMCustomBannerEvent;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;->goto:Z
...
# virtual methods
.method public final callBannerAdClicked()V
    .locals 1

    .line 1
    iget-boolean v0, p0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;->goto:Z
    ...
    .line 3
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$2;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$2;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;)V
...
.method public final callBannerAdClosed()V
    ...
    .line 3
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$3;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$3;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;)V
...
.method public final callBannerAdLeftApplication()V
    .locals 1
    ...
    .line 2
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$5;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$5;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;)V
...
.method public final callBannerAdOpened()V
    .locals 1
    ...
    .line 2
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$4;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$4;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;)V
...
.method public final callBannerAdShow()V
    ...
    .line 2
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$1;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter$1;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;)V
...
.method public final callLoadSuccess()V
    ...
    .line 1
    invoke-virtual {p0, v0, v1}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;->callLoadSuccess(D)V
...
.method public final callLoadSuccess(D)V
    ...
    .line 4
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAd;

    invoke-direct {v0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAd;-><init>()V
...
.method public final getAdViewInner()Landroid/view/View;
    .locals 1

    .line 1
    :try_start_0
    invoke-virtual {p0}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;->getAdView()Landroid/view/View;
...
.method public abstract load(Landroid/content/Context;Lcom/bytedance/msdk/api/v2/slot/GMAdSlotBanner;Lcom/bytedance/msdk/api/v2/ad/custom/bean/GMCustomServiceConfig;)V
.end method
...
.method public loadCustom(Landroid/content/Context;Lcom/bytedance/msdk/api/v2/slot/GMAdSlotBase;Lcom/bytedance/msdk/api/v2/ad/custom/bean/GMCustomServiceConfig;)V
    ...
    .line 1
    instance-of v0, p2, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotBanner;

    if-eqz v0, :cond_0

    .line 2
    check-cast p2, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotBanner;

    invoke-virtual {p0, p1, p2, p3}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;->load(Landroid/content/Context;Lcom/bytedance/msdk/api/v2/slot/GMAdSlotBanner;Lcom/bytedance/msdk/api/v2/ad/custom/bean/GMCustomServiceConfig;)V
    ...
    const-string p3, "ClassCastException\uff1aload ad fail adSlot is not GMAdSlotBanner"

    invoke-direct {p1, p2, p3}, Lcom/bytedance/msdk/api/v2/ad/custom/GMCustomAdError;-><init>(ILjava/lang/String;)V

    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/api/v2/ad/custom/banner/GMCustomBannerAdapter;->callLoadFail(Lcom/bytedance/msdk/api/v2/ad/custom/GMCustomAdError;)V
