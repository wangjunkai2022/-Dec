.class public abstract Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;
.super Lcom/bytedance/msdk/api/v2/ad/custom/base/GMCustomVideoAdapter;
.source "GMCustomInterstitialAdapter.java"

# interfaces
.implements Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/IGMCustomInterstitialEvent;
...
.method public constructor <init>()V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;->goto:Z
...
.method public final callInterstitialAdClick()V
    ...
    .line 1
    iget-boolean v0, p0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;->goto:Z
    ...
    .line 3
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$2;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$2;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;)V
...
.method public final callInterstitialAdLeftApplication()V
    ...
    .line 2
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$5;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$5;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;)V
...
.method public final callInterstitialAdOpened()V
    ...
    .line 2
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$4;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$4;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;)V
...
.method public final callInterstitialClosed()V
    ...
    .line 3
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$3;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$3;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;)V
...
.method public final callInterstitialShow()V
    ...
    .line 2
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$1;

    invoke-direct {v0, p0}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter$1;-><init>(Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;)V
...
.method public final callLoadSuccess()V
    ...
    .line 1
    invoke-virtual {p0, v0, v1}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;->callLoadSuccess(D)V
...
.method public final callLoadSuccess(D)V
    ...
    .line 4
    new-instance v0, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAd;

    invoke-direct {v0}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAd;-><init>()V
...
.method public abstract load(Landroid/content/Context;Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitial;Lcom/bytedance/msdk/api/v2/ad/custom/bean/GMCustomServiceConfig;)V
.end method
...
.method public loadCustom(Landroid/content/Context;Lcom/bytedance/msdk/api/v2/slot/GMAdSlotBase;Lcom/bytedance/msdk/api/v2/ad/custom/bean/GMCustomServiceConfig;)V
    ...
    .line 3
    invoke-virtual {p2}, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitialFull;->getGMAdSlotInterstitial()Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitial;

    move-result-object p2

    .line 4
    invoke-virtual {p0, p1, p2, p3}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;->load(Landroid/content/Context;Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitial;Lcom/bytedance/msdk/api/v2/ad/custom/bean/GMCustomServiceConfig;)V

    goto :goto_0

    .line 5
    :cond_0
    instance-of v0, p2, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitial;

    if-eqz v0, :cond_1

    .line 6
    check-cast p2, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitial;
    ...
    const-string p3, "ClassCastException\uff1aload ad fail adSlot is not GMAdSlotInterstitialFull or GMAdSlotInterstitial"

    invoke-direct {p1, p2, p3}, Lcom/bytedance/msdk/api/v2/ad/custom/GMCustomAdError;-><init>(ILjava/lang/String;)V

    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/api/v2/ad/custom/interstitial/GMCustomInterstitialAdapter;->callLoadFail(Lcom/bytedance/msdk/api/v2/ad/custom/GMCustomAdError;)V
