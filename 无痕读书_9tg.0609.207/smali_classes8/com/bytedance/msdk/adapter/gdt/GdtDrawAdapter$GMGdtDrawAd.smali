.class public Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter;
.end annotation
...
.field public if:Lcom/qq/e/ads/cfg/VideoOption;

.field public new:Lcom/qq/e/ads/nativ/NativeADMediaListener;


# direct methods
.method public constructor <init>(Lcom/qq/e/ads/nativ/NativeUnifiedADData;Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter;Lcom/qq/e/ads/cfg/VideoOption;)V
    .locals 3
    ...
    iput-boolean v0, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->for:Z

    new-instance v1, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd$3;

    invoke-direct {v1, p0}, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd$3;-><init>(Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;)V

    iput-object v1, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->new:Lcom/qq/e/ads/nativ/NativeADMediaListener;

    iput-object p1, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do:Lcom/qq/e/ads/nativ/NativeUnifiedADData;

    iput-object p3, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->if:Lcom/qq/e/ads/cfg/VideoOption;
    ...
    invoke-virtual {p0, p3}, Lcom/bytedance/msdk/base/TTBaseAd;->setAppName(Ljava/lang/String;)V

    invoke-interface {p1}, Lcom/qq/e/ads/nativ/NativeUnifiedADAppMiitInfo;->getAuthorName()Ljava/lang/String;

    move-result-object p3

    invoke-virtual {p0, p3}, Lcom/bytedance/msdk/base/TTBaseAd;->setAuthorName(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p3}, Lcom/bytedance/msdk/base/TTBaseAd;->setPermissionsUrl(Ljava/lang/String;)V

    invoke-interface {p1}, Lcom/qq/e/ads/nativ/NativeUnifiedADAppMiitInfo;->getPrivacyAgreement()Ljava/lang/String;

    move-result-object p3

    invoke-virtual {p0, p3}, Lcom/bytedance/msdk/base/TTBaseAd;->setPrivacyAgreement(Ljava/lang/String;)V

    invoke-interface {p1}, Lcom/qq/e/ads/nativ/NativeUnifiedADAppMiitInfo;->getVersionName()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setVersionName(Ljava/lang/String;)V

    :cond_0
    iget-object p1, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do:Lcom/qq/e/ads/nativ/NativeUnifiedADData;

    invoke-interface {p1}, Lcom/qq/e/ads/nativ/NativeUnifiedADData;->getTitle()Ljava/lang/String;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setTitle(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setAdDescription(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setActionText(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setIconUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setImageUrl(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setImageHeight(I)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setSource(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bytedance/msdk/base/TTBaseAd;->setIsAppDownload(Z)V
    ...
    const-string p3, "TTMediationSDK_ECMP"
    ...
    const-string p2, "GDT_clientBidding draw \u8fd4\u56de\u7684 cpm\u4ef7\u683c\uff1a"

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    iget-object p2, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do:Lcom/qq/e/ads/nativ/NativeUnifiedADData;
    ...
    :cond_2
    invoke-virtual {p2}, Lcom/bytedance/msdk/adapter/TTAbsAdLoaderAdapter;->isMultiBidding()Z
    ...
    const-string p2, "GDT_\u591a\u9636\u5e95\u4ef7 draw \u8fd4\u56de\u7684 \u4ef7\u683c\u6807\u7b7e\uff1a"
    ...
    invoke-static {p3, p1}, Lcom/bytedance/msdk/adapter/util/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p2, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd$1;

    invoke-direct {p2}, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd$1;-><init>()V

    invoke-interface {p1, p2}, Lcom/qq/e/ads/nativ/NativeUnifiedADData;->preloadVideo(Lcom/qq/e/ads/nativ/VideoPreloadListener;)V
    ...
    :cond_6
    :goto_2
    invoke-virtual {p0, p3}, Lcom/bytedance/msdk/base/TTBaseAd;->setImageMode(I)V
    ...
    :cond_8
    invoke-virtual {p0, p3}, Lcom/bytedance/msdk/base/TTBaseAd;->setInteractionType(I)V
...
.method public bidLoseNotify(Ljava/util/Map;)V
    ...
    :cond_0
    iget-object v0, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do:Lcom/qq/e/ads/nativ/NativeUnifiedADData;
...
.method public final do(Landroid/content/Context;Landroid/view/ViewGroup;Ljava/util/List;Ljava/util/List;Lcom/bytedance/msdk/api/v2/ad/nativeAd/GMViewBinder;)V
    ...
    iget-object v2, v0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do:Lcom/qq/e/ads/nativ/NativeUnifiedADData;
    ...
    iget-object v1, v0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do:Lcom/qq/e/ads/nativ/NativeUnifiedADData;
    ...
    iget-object v3, v0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->if:Lcom/qq/e/ads/cfg/VideoOption;

    iget-object v4, v0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->new:Lcom/qq/e/ads/nativ/NativeADMediaListener;
    ...
    new-instance v2, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd$2;

    invoke-direct {v2, p0}, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd$2;-><init>(Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;)V
...
.method public hasDestroyed()Z
    ...
    iget-boolean v0, p0, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->for:Z
...
.method public registerViewForInteraction(Landroid/app/Activity;Landroid/view/ViewGroup;Ljava/util/List;Ljava/util/List;Ljava/util/List;Lcom/bytedance/msdk/api/v2/ad/nativeAd/GMViewBinder;)V
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/bytedance/msdk/adapter/gdt/GdtDrawAdapter$GMGdtDrawAd;->do(Landroid/content/Context;Landroid/view/ViewGroup;Ljava/util/List;Ljava/util/List;Lcom/bytedance/msdk/api/v2/ad/nativeAd/GMViewBinder;)V
