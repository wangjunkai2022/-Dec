.class public abstract Lcom/bytedance/msdk/adapter/ad/GMFullVideoBaseAdapter;
.super Lcom/bytedance/msdk/adapter/TTAbsAdLoaderAdapter;
.source "GMFullVideoBaseAdapter.java"


# instance fields
.field public mGMAdSlotFullVideo:Lcom/bytedance/msdk/api/v2/slot/GMAdSlotFullVideo;
...
.method public loadAd(Landroid/content/Context;Ljava/util/Map;)V
    ...
    invoke-virtual {p1}, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotInterstitialFull;->getGMAdSlotFullVideo()Lcom/bytedance/msdk/api/v2/slot/GMAdSlotFullVideo;

    move-result-object p1

    iput-object p1, p0, Lcom/bytedance/msdk/adapter/ad/GMFullVideoBaseAdapter;->mGMAdSlotFullVideo:Lcom/bytedance/msdk/api/v2/slot/GMAdSlotFullVideo;

    goto :goto_0

    .line 3
    :cond_0
    instance-of p2, p1, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotFullVideo;

    if-eqz p2, :cond_1

    .line 4
    check-cast p1, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotFullVideo;
    ...
    const-string p2, "ClassCastException\uff1aload ad fail mGMAdSlotFullVideo is not GMAdSlotInterstitialFull or GMAdSlotFullVideo"
...
.method public notifyLoadFailBecauseGMAdSlotIsNull()V
    ...
    const-string v1, "load ad fail mGMAdSlotFullVideo is null"
