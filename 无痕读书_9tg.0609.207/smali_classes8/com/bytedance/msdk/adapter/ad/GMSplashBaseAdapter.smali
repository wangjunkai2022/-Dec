.class public abstract Lcom/bytedance/msdk/adapter/ad/GMSplashBaseAdapter;
.super Lcom/bytedance/msdk/adapter/TTAbsAdLoaderAdapter;
.source "GMSplashBaseAdapter.java"


# instance fields
.field public mGMAdSlotSplash:Lcom/bytedance/msdk/api/v2/slot/GMAdSlotSplash;
...
.method public loadAd(Landroid/content/Context;Ljava/util/Map;)V
    ...
    instance-of p2, p1, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotSplash;

    if-eqz p2, :cond_0

    .line 2
    check-cast p1, Lcom/bytedance/msdk/api/v2/slot/GMAdSlotSplash;

    iput-object p1, p0, Lcom/bytedance/msdk/adapter/ad/GMSplashBaseAdapter;->mGMAdSlotSplash:Lcom/bytedance/msdk/api/v2/slot/GMAdSlotSplash;
    ...
    const-string p2, "ClassCastException\uff1aload ad fail mGMAdSlotSplash is not GMAdSlotSplash"
...
.method public notifyLoadFailBecauseGMAdSlotIsNull()V
    ...
    const-string v1, "load ad fail mGMAdSlotSplash is null"
